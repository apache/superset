...
| supersetCeleryBeat.image.repository | string | `nil` |  |
| supersetCeleryBeat.image.tag | string | `nil` |  |
...
| supersetCeleryFlower.image.repository | string | `nil` |  |
| supersetCeleryFlower.image.tag | string | `nil` |  |
...
| supersetWorker.image.repository | string | `nil` |  |
| supersetWorker.image.tag | string | `nil` |  |
