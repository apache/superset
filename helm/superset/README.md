...
| init.topologySpreadConstraints | list | `[]` | TopologySpreadConstraints to be added to init job |
...
| supersetCeleryBeat.topologySpreadConstraints | list | `[]` | TopologySpreadConstraints to be added to supersetCeleryBeat deployments |
...
| supersetCeleryFlower.topologySpreadConstraints | list | `[]` | TopologySpreadConstraints to be added to supersetCeleryFlower deployments |
...
| supersetWebsockets.topologySpreadConstraints | list | `[]` | TopologySpreadConstraints to be added to supersetWebsockets deployments |
...
| supersetWorker.topologySpreadConstraints | list | `[]` | TopologySpreadConstraints to be added to supersetWorker deployments |
| tolerations | list | `[]` |  |
