...
|------------|------|---------|
| oci://registry-1.docker.io/cloudpirates | postgresql(postgres) | 0.7.0 |
| oci://registry-1.docker.io/cloudpirates | redis | 0.4.6 |
...
| nodeSelector | object | `{}` |  |
| postgresql | object | see `values.yaml` | Configuration values for the postgresql dependency. ref: https://github.com/CloudPirates-io/helm-charts/tree/main/charts/postgres |
| priorityClassName | string | `nil` | Set priorityClassName for superset pods |
| redis | object | see `values.yaml` | Configuration values for the Redis dependency. ref: https://github.com/CloudPirates-io/helm-charts/tree/main/charts/redis More documentation can be found here: https://artifacthub.io/packages/helm/cloudpirates-redis/redis |
| resources | object | `{}` |  |
