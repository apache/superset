 ...
 * under the License.
 */
// Generated from superset/examples/countries.py so the world map can join
// country codes to cca3/coordinates client-side, as the legacy explore_json
// endpoint used to do server-side.
