...
import { formatSelectOptionsForRange, ColumnOption, columnChoices, sections, } from '@superset-ui/chart-controls';
const config = {
                ...
                [
                    {
                        ...
                        config: {
                            ...
                            default: (control) => control.choices && control.choices.length > 0
                                ? control.choices[0][0]
                                : null,
