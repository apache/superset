...
export let ReducerActions;(function (ReducerActions) {ReducerActions["init"] = "init";ReducerActions["setStickyState"] = "setStickyState";})(ReducerActions || (ReducerActions = {}));
...

{
  ...
  const columnCount = useMemo(() => {var _thead;
    const headerRows = React.Children.toArray((_thead =
    thead) == null ? void 0 : _thead.props.children).
    pop();
...
useSticky.pluginName = 'useSticky';;(function () {var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;if (!reactHotLoader) {return;}reactHotLoader.register(sum, "sum", "/Users/evan/GitHub/superset/superset-frontend/plugins/plugin-chart-table/src/DataTable/hooks/useSticky.tsx");reactHotLoader.register(mergeStyleProp, "mergeStyleProp", "/Users/evan/GitHub/superset/superset-frontend/plugins/plugin-chart-table/src/DataTable/hooks/useSticky.tsx");reactHotLoader.register(fixedTableLayout, "fixedTableLayout", "/Users/evan/GitHub/superset/superset-frontend/plugins/plugin-chart-table/src/DataTable/hooks/useSticky.tsx");reactHotLoader.register(StickyWrap, "StickyWrap", "/Users/evan/GitHub/superset/superset-frontend/plugins/plugin-chart-table/src/DataTable/hooks/useSticky.tsx");reactHotLoader.register(useInstance, "useInstance", "/Users/evan/GitHub/superset/superset-frontend/plugins/plugin-chart-table/src/DataTable/hooks/useSticky.tsx");reactHotLoader.register(useSticky, "useSticky", "/Users/evan/GitHub/superset/superset-frontend/plugins/plugin-chart-table/src/DataTable/hooks/useSticky.tsx");})();;(function () {var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;leaveModule && leaveModule(module);})();