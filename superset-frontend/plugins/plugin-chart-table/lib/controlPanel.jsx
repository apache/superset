...
const all_columns = {
    ...
    mapStateToProps: ({ datasource, controls }, controlState) => ({
        ...
        externalValidationErrors: isRawMode({ controls }) && ensureIsArray(controlState.value).length === 0
            ? [t('must have a value')]
            : [],
    }),
                ...
                [
                    {
                        ...
                        override: {
                            validators: [],
                            visibility: isAggMode,
                            mapStateToProps: ({ controls, datasource, form_data }, controlState) => ({
                ...
                [
                    {
                        name: 'row_limit',
                        override: {
                            visibility: ({ controls }) => !controls?.server_pagination?.value,
                        },
                    },
                    {
                        ...
                        config: {
                            ...
                            visibility: ({ controls }) => Boolean(controls?.server_pagination?.value),
                        },
                    },
                ],
                [
