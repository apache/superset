...
export default React.memo(function SelectPageSize({ total, options: sizeOptions, current: currentSize, selectRenderer, onChange, }) {
...
//# sourceMappingURL=SelectPageSize.jsx.map