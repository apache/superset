...
const transformProps = (
  ...
  const {
    ...
    enable_multi_header: enableMultiHeader = false,
  ...
  return {
    ...
    allowRearrangeColumns:
      allowRearrangeColumns && !(enableMultiHeader && !isUsingTimeComparison),
    allowRenderHtml,
    onContextMenu,
    isUsingTimeComparison,
    enableMultiHeader: enableMultiHeader && !isUsingTimeComparison,
    headerGroups,
