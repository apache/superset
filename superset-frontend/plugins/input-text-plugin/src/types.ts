...
export interface InputTextPluginStylesProps {
  height: number;
  width: number;
...
export type InputTextPluginQueryFormData = QueryFormData &
  InputTextPluginStylesProps &
  InputTextPluginCustomizeProps;

export type InputTextPluginProps = InputTextPluginStylesProps &
  InputTextPluginCustomizeProps & {
