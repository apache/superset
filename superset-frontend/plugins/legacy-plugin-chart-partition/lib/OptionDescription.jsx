...
export default function OptionDescription({ option }) {
    return (<span>
      ...
      {option.description && (<InfoTooltipWithTrigger className="m-r-5 text-muted" icon="question-circle-o" tooltip={option.description} label={`descr-${option.label}`}/>)}
    </span>);
}
OptionDescription.propTypes = propTypes;
//# sourceMappingURL=OptionDescription.jsx.map