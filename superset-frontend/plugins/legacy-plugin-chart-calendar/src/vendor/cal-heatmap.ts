...
// @ts-expect-error TS(7016): Could not find a declaration file for module 'd3-t... Remove this comment to see the full error message
...
var CalHeatMap = function(this: $TSFixMe) {
  'use strict';
  ...
  self.legendTip = d3tip()
    ...
    .direction('n')
    .offset([-5, 0])
    .html((d: $TSFixMe) => self.options.valueFormatter(d));
  ...
  this.options = {
    ...
    valueFormatter: (d: $TSFixMe) => d,

    timeFormatter: (d: $TSFixMe) => d,
    ...
    afterLoadData: function (timestamps: $TSFixMe) {
      // See https://github.com/wa0x6e/cal-heatmap/issues/126#issuecomment-373301803
      const stdTimezoneOffset = (date: $TSFixMe) => {
  ...
  this._domainType = {
    min: {
      ...
      extractUnit: function (d: $TSFixMe) {
        return new Date(
          d.getFullYear(),
          d.getMonth(),
          d.getDate(),
    ...
    hour: {
      ...
      maxItemNumber: function (d: $TSFixMe) {
      ...
      defaultRowNumber: 6,
      defaultColumnNumber: function (d: $TSFixMe) {
        switch (self.options.domain) {
          case 'day':
            return 4;
          case 'week':
  ...
  this._init = function () {
    self
      ...
      .map(function (d: $TSFixMe) {
        self._domains.set(
          d,
          self.getSubDomain(d).map(function (d: $TSFixMe) {
            return {
  ...
  function w(d: $TSFixMe, outer: $TSFixMe) {
    var width =
  ...
  function h(d: $TSFixMe, outer: $TSFixMe) {
    var height =
   ...
   */
  this.paint = function (navigationDir: $TSFixMe) {
    ...
    var svg = domainSvg
      .enter()
      .append('svg')
      .attr('width', function (d: $TSFixMe) {
        return w(d, true);
      })
      .attr('height', function (d: $TSFixMe) {
        return h(d, true);
      })
    ...
    function getDomainPosition(domainIndex: $TSFixMe, graphDim: $TSFixMe, axis: $TSFixMe, domainDim: $TSFixMe) {
      var tmp = 0;
    ...
    rect
      ...
      .on('click', function (d: $TSFixMe) {
        if (options.onClick !== null) {
          return self.onClick(new Date(d.t), d.v);
        }
      })
      .call(function (selection: $TSFixMe) {
        ...
        if (options.tooltip) {
          selection
            .on('mouseover', function(this: $TSFixMe, d: $TSFixMe) {
    ...
    if (!options.tooltip) {
      rect.append('title').text(function (d: $TSFixMe) {
    ...
    function domainRotate(selection: $TSFixMe) {
      switch (options.label.rotate) {
        case 'right':
          selection.attr('transform', function (d: $TSFixMe) {
            var s = 'rotate(90), ';
            switch (options.label.position) {
              case 'right':
                // @ts-expect-error TS(2554): Expected 2 arguments, but got 1.
...
CalHeatMap.prototype = {
  ...
  init: function (settings: $TSFixMe) {
    'use strict';
     ...
     */
    function validateSelector(selector: $TSFixMe, canBeFalse: $TSFixMe, name: $TSFixMe) {
      if (
     ...
     */
    function getOptimalSubDomain(domain: $TSFixMe) {
      switch (domain) {
        case 'year':
          return 'month';
        case 'month':
     ...
     * @return {array}        array
     */
    function expandMarginSetting(value: $TSFixMe) {
     ...
     */
    function expandItemName(value: $TSFixMe) {
    ...
    function parseColLimit(value: $TSFixMe) {
      return value > 0 ? value : null;
    }

    function parseRowLimit(value: $TSFixMe) {
   ...
   */
  expandDateSetting: function (value: $TSFixMe) {
    'use strict';
  ...
  fill: function (svg: $TSFixMe) {
     ...
     */
    // @ts-expect-error TS(7030): Not all code paths return a value.
    function addStyle(element: $TSFixMe) {
      if (parent.legendScale === null) {
        return false;
      }

      element.attr('fill', function (d: $TSFixMe) {
        if (
          d.v === null &&
    ...
    function formatSubDomainText(element: $TSFixMe) {
      if (typeof options.subDomainTextFormat === 'function') {
        element.text(function (d: $TSFixMe) {
   ...
   * @return String
   */
  formatStringWithObject: function (formatted: $TSFixMe, args: $TSFixMe) {
    'use strict';
   ...
   */
  triggerEvent: function (eventName: $TSFixMe, successArgs: $TSFixMe, skip: $TSFixMe) {
    'use strict';
   ...
   */
  onClick: function (d: $TSFixMe, itemNb: $TSFixMe) {
    'use strict';
   ...
   */
  afterLoadPreviousDomain: function (start: $TSFixMe) {
    'use strict';
   ...
   * @param  Date    end    Domain end date
   */
  afterLoadNextDomain: function (start: $TSFixMe) {
    'use strict';
   ...
   */
  onMinDomainReached: function (reached: $TSFixMe) {
    'use strict';
   ...
   */
  onMaxDomainReached: function (reached: $TSFixMe) {
    'use strict';
  ...
  checkIfMinDomainIsReached: function (date: $TSFixMe, upperBound: $TSFixMe) {
    'use strict';
  ...
  checkIfMaxDomainIsReached: function (date: $TSFixMe, lowerBound: $TSFixMe) {
    'use strict';
  ...
  formatDate: function (d: $TSFixMe, format: $TSFixMe) {
    'use strict';
  ...
  getSubDomainTitle: function (d: $TSFixMe) {
    'use strict';
   ...
   */
  loadNextDomain: function (n: $TSFixMe) {
    'use strict';
   ...
   */
  loadPreviousDomain: function (n: $TSFixMe) {
    'use strict';
  ...
  loadNewDomains: function (direction: $TSFixMe, newDomains: $TSFixMe) {
    'use strict';
    ...
    function buildSubDomain(d: $TSFixMe) {
      return {
   ...
   */
  maxDomainIsReached: function (datetimestamp: $TSFixMe) {
    'use strict';
   ...
   */
  minDomainIsReached: function (datetimestamp: $TSFixMe) {
    'use strict';
  ...
  getDomainKeys: function () {
    ...
    return this._domains
      ...
      .sort(function (a: $TSFixMe, b: $TSFixMe) {
        return a - b;
      });
  },
  ...
  positionSubDomainX: function (d: $TSFixMe) {
    'use strict';
  ...
  positionSubDomainY: function (d: $TSFixMe) {
    'use strict';
  ...
  getSubDomainColumnNumber: function (d: $TSFixMe) {
    'use strict';
  ...
  getSubDomainRowNumber: function (d: $TSFixMe) {
    'use strict';
   ...
   */
  getHighlightClassName: function (d: $TSFixMe) {
    'use strict';
  ...
  dateIsEqual: function (dateA: $TSFixMe, dateB: $TSFixMe) {
    'use strict';
   ...
   * @returns {boolean}
   */
  dateIsLessThan: function (dateA: $TSFixMe, dateB: $TSFixMe) {
    'use strict';
    ...
    function normalizedMillis(date: $TSFixMe, subdomain: $TSFixMe) {
      switch (subdomain) {
        case 'x_min':
        case 'min':
          return new Date(
   ...
   */
  getWeekNumber: function (d: $TSFixMe) {
    'use strict';
   ...
   */
  getMonthWeekNumber: function (d: $TSFixMe) {
    'use strict';
   ...
   */
  getWeekNumberInYear: function (d: $TSFixMe) {
    'use strict';
   ...
   */
  getDayCountInMonth: function (d: $TSFixMe) {
    'use strict';
   ...
   */
  getDayCountInYear: function (d: $TSFixMe) {
    'use strict';
   ...
   */
  getEndOfMonth: function (d: $TSFixMe) {
    'use strict';
   ...
   * @return Date
   */
  jumpDate: function (date: $TSFixMe, count: $TSFixMe, step: $TSFixMe) {
    'use strict';
   ...
   */
  getMinuteDomain: function (d: $TSFixMe, range: $TSFixMe) {
    'use strict';
   ...
   */
  getHourDomain: function (d: $TSFixMe, range: $TSFixMe) {
    'use strict';
   ...
   */
  getDayDomain: function (d: $TSFixMe, range: $TSFixMe) {
    'use strict';
   ...
   * @return array  An array of weeks
   */
  getWeekDomain: function (d: $TSFixMe, range: $TSFixMe) {
    'use strict';
   ...
   */
  getMonthDomain: function (d: $TSFixMe, range: $TSFixMe) {
    'use strict';
   ...
   * @return array  An array of hours
   */
  getYearDomain: function (d: $TSFixMe, range: $TSFixMe) {
    'use strict';
   ...
   */
  getDomain: function (date: $TSFixMe, range: $TSFixMe) {
    'use strict';
  ...
  /* jshint maxcomplexity: false */
  getSubDomain: function (date: $TSFixMe) {
    'use strict';
     ...
     * @return int
     */
    var computeDaySubDomainSize = function (date: $TSFixMe, domain: $TSFixMe) {
      switch (domain) {
        case 'year':
     ...
     */
    // @ts-expect-error TS(7030): Not all code paths return a value.
    var computeMinSubDomainSize = function (date: $TSFixMe, domain: $TSFixMe) {
      switch (domain) {
        case 'hour':
          return 60;
        case 'day':
     ...
     */
    // @ts-expect-error TS(7030): Not all code paths return a value.
    var computeHourSubDomainSize = function (date: $TSFixMe, domain: $TSFixMe) {
      switch (domain) {
        case 'day':
          return 24;
        case 'week':
     ...
     * @return int
     */
    var computeWeekSubDomainSize = function (date: $TSFixMe, domain: $TSFixMe) {
      if (domain === 'month') {
   ...
   */
  getNextDomain: function (n: $TSFixMe) {
    'use strict';
   ...
   * @return Date The start date of the wanted domain
   */
  getPreviousDomain: function (n: $TSFixMe) {
    'use strict';
  ...
  getDatas: function (
    ...
    var _callback = function(this: $TSFixMe, error: $TSFixMe, data: $TSFixMe) {
      if (afterLoad !== false) {
   ...
   * @return void
   */
  parseDatas: function (data: $TSFixMe, updateMode: $TSFixMe, startDate: $TSFixMe, endDate: $TSFixMe) {
    'use strict';

    if (updateMode === this.RESET_ALL_ON_UPDATE) {
      this._domains.forEach(function (key: $TSFixMe, value: $TSFixMe) {
        value.forEach(function (element: $TSFixMe, index: $TSFixMe, array: $TSFixMe) {
          array[index].v = null;
        });
      });
    }
    ...
    var extractTime = function (d: $TSFixMe) {
      return d.t;
    };
  ...
  parseURI: function (str: $TSFixMe, startDate: $TSFixMe, endDate: $TSFixMe) {
    'use strict';
  ...
  interpretCSV: function (data: $TSFixMe) {
    'use strict';
   ...
   */
  jumpTo: function (date: $TSFixMe, reset: $TSFixMe) {
    'use strict';
   ...
   */
  update: function (dataSource: $TSFixMe, afterLoad: $TSFixMe, updateMode: $TSFixMe) {
    'use strict';
   ...
   */
  highlight: function (args: $TSFixMe) {
    'use strict';
   ...
   * @return null
   */
  destroy: function (callback: $TSFixMe) {
    'use strict';
  ...
  getSVG: function () {
    ...
    var filterStyles = function (attribute: $TSFixMe, property: $TSFixMe, value: $TSFixMe) {
    ...
    var getElement = function (e: $TSFixMe) {
 ...
 */
var DomainPosition = function(this: $TSFixMe) {
  'use strict';

  this.positions = d3.map();
};

DomainPosition.prototype.getPosition = function (d: $TSFixMe) {
  'use strict';

  return this.positions.get(d);
};

DomainPosition.prototype.getPositionFromIndex = function (i: $TSFixMe) {
  'use strict';
...
DomainPosition.prototype.setPosition = function (d: $TSFixMe, dim: $TSFixMe) {
  'use strict';

  this.positions.set(d, dim);
};

DomainPosition.prototype.shiftRightBy = function (exitingDomainDim: $TSFixMe) {
  'use strict';

  this.positions.forEach(function(this: $TSFixMe, key: $TSFixMe, value: $TSFixMe) {
...
DomainPosition.prototype.shiftLeftBy = function (enteringDomainDim: $TSFixMe) {
  'use strict';
...
DomainPosition.prototype.getKeys = function () {
  ...
  return this.positions.keys().sort(function (a: $TSFixMe, b: $TSFixMe) {
...
var Legend = function(this: $TSFixMe, calendar: $TSFixMe) {
  'use strict';
...
// @ts-expect-error TS(7030): Not all code paths return a value.
Legend.prototype.redraw = function (width: $TSFixMe) {
  'use strict';
  ...
  legendItem
    .transition()
    .delay(function (d: $TSFixMe, i: $TSFixMe) {
      return (options.animationDuration * i) / 10;
    })
    .call(legendCellLayout)
    .attr('fill-opacity', 1)
    .call(function (element: $TSFixMe) {
      element.attr('fill', function (d: $TSFixMe, i: $TSFixMe) {
      ...
      element.attr('class', function (d: $TSFixMe) {
        return calendar.Legend.getClass(d, calendar.legendScale === null);
      });
    });

  function legendCellLayout(selection: $TSFixMe) {
    selection
      ...
      .attr('x', function (d: $TSFixMe, i: $TSFixMe) {
        return i * (options.legendCellSize + options.legendCellPadding);
      });
  }

  legendItem.select('title').text(function (d: $TSFixMe, i: $TSFixMe) {
    if (i === 0) {
 ...
 */
Legend.prototype.getDim = function (axis: $TSFixMe) {
  'use strict';
...
Legend.prototype.buildColors = function () {
  ...
  var legendColors = _legend.map(function (element: $TSFixMe) {
 ...
 */
Legend.prototype.getClass = function (n: $TSFixMe, withCssClass: $TSFixMe) {
  'use strict';
 ...
 */
function mergeRecursive(obj1: $TSFixMe, obj2: $TSFixMe) {
  'use strict';
 ...
 */
function arrayEquals(arrayA: $TSFixMe, arrayB: $TSFixMe) {
  'use strict';
