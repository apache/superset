      ...
      return function () {
        return {
          ...
          push(record) {
            ...
            if (record.currencyColumnKey && record[record.currencyColumnKey]) {
              this.currencySet.add(record[record.currencyColumnKey]);
            }
          },
          value() {
            return fn(this.uniq);
        ...
        return {
          ...
          push(record) {
            ...
            if (Number.isNaN(x)) {
              ...
              if (
                record.currencyColumnKey &&
                record[record.currencyColumnKey]
              ) {
                this.currencySet.add(record[record.currencyColumnKey]);
              }
              return;
