...
import { getColumnLabel, getNumberFormatter, isPhysicalColumn, styled, useTheme, } from '@superset-ui/core';
...
export default function PivotTableChart(props) {
    ...
    const columnFormatsArray = useMemo(() => Object.entries(columnFormats), [columnFormats]);
    ...
    const toggleFilter = useCallback((e, value, filters, pivotData, isSubtotal, isGrandTotal) => {
        ...
        const isActiveFilterValue = (key, val) => !!selectedFilters && selectedFilters[key]?.includes(val);
