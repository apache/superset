...
import { EchartsRadarChartProps, EchartsRadarLabelType, RadarChartTransformedProps } from './types';
export declare function formatLabel({ params, labelType, numberFormatter, }: {
