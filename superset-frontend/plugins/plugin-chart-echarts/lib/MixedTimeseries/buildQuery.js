 ...
 * under the License.
 */
import { buildQueryContext, normalizeOrderBy, } from '@superset-ui/core';
import { pivotOperator } from '@superset-ui/chart-controls';
export default function buildQuery(formData) {
    const { adhoc_filters, adhoc_filters_b, groupby, groupby_b, limit, limit_b, timeseries_limit_metric, timeseries_limit_metric_b, metrics, metrics_b, order_desc, order_desc_b, ...baseFormData } = formData;
