...
const smoothTransformProps = (chartProps) => transformProps({
    ...chartProps,
    formData: {
        ...chartProps.formData,
    ...
    constructor() {
        super({
            ...
            metadata: new ChartMetadata({
                ...
                description: t('Time-series Smooth-line is a variation of line chart. Without angles and hard edges, Smooth-line looks more smarter and more professional.'),
