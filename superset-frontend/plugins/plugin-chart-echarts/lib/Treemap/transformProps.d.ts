...
import { EchartsTreemapChartProps, EchartsTreemapLabelType, TreemapSeriesCallbackDataParams, TreemapTransformedProps } from './types';
...
export declare function formatTooltip({ params, numberFormatter, }: {
    params: TreemapSeriesCallbackDataParams;
    numberFormatter: NumberFormatter;
}): string;
