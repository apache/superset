...
export declare type EchartsTreemapFormData = QueryFormData & {
    colorScheme?: string;
...
export declare enum EchartsTreemapLabelType {
    Key = "key",
    Value = "value",
    KeyValue = "key_value"
}
...
export declare const DEFAULT_FORM_DATA: Partial<EchartsTreemapFormData>;
