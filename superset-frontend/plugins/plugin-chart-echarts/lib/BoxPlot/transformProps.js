...
export default function transformProps(chartProps) {
    ...
    const { colorScheme, groupby = [], metrics = [], numberFormat, dateFormat, xTicksLayout, emitFilter, legendOrientation = 'top', xAxisTitle, yAxisTitle, xAxisTitleMargin, yAxisTitleMargin, yAxisTitlePosition, } = formData;
    ...
    const chartPadding = getPadding(true, legendOrientation, addYAxisTitleOffset, false, null, addXAxisTitleOffset, yAxisTitlePosition, yAxisTitleMargin, xAxisTitleMargin);
    const echartOptions = {
        grid: {
            ...defaultGrid,
            ...chartPadding,
