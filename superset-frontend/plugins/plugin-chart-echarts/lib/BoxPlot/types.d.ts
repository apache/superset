...
export declare type BoxPlotQueryFormData = QueryFormData & {
    numberFormat?: string;
    whiskerOptions?: BoxPlotFormDataWhiskerOptions;
    xTickLayout?: BoxPlotFormXTickLayout;
    emitFilter: boolean;
} & EchartsTitleFormData;
export declare type BoxPlotFormDataWhiskerOptions = 'Tukey' | 'Min/max (no outliers)' | '2/98 percentiles' | '9/91 percentiles';
export declare type BoxPlotFormXTickLayout = '45°' | '90°' | 'auto' | 'flat' | 'staggered';
export declare const DEFAULT_FORM_DATA: BoxPlotQueryFormData;
