 ...
 * under the License.
 */
import { extractTimegrain, getNumberFormatter, NumberFormats, GenericDataType, getMetricLabel, t, smartDateVerboseFormatter, } from '@superset-ui/core';
...
export default function transformProps(chartProps) {
    ...
    const formatTime = getDateFormatter(timeFormat, granularity, metricEntry?.d3format);
