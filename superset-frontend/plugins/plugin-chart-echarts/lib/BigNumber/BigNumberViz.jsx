...
class BigNumberVis extends React.PureComponent {
    ...
    renderFallbackWarning() {
        ...
        if (!bigNumberFallback || showTimestamp)
            return null;
        return (<span className="alert alert-warning" role="alert" title={t(`Last available value seen on %s`, formatTime(bigNumberFallback[0]))}>
        {t('Not up to date')}
      </span>);
    }
    renderKicker(maxHeight) {
        ...
        container.remove();
        return (<div className="kicker" style={{
                fontSize,
                height: maxHeight,
            }}>
        {text}
    ...
    renderHeader(maxHeight) {
        ...
        container.remove();
        return (<div className="header-line" style={{
                fontSize,
                height: maxHeight,
            }}>
        {text}
    ...
    renderSubheader(maxHeight) {
        ...
        if (text) {
            ...
            container.remove();
            return (<div className="subheader-line" style={{
                    fontSize,
                    height: maxHeight,
                }}>
          {text}
    ...
    renderTrendline(maxHeight) {
        ...
        return (<Echart width={Math.floor(width)} height={maxHeight} echartOptions={echartOptions}/>);
    }
    render() {
...
`;
//# sourceMappingURL=BigNumberViz.jsx.map