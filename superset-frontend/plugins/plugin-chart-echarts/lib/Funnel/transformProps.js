...
export function formatFunnelLabel({ params, labelType, numberFormatter, sanitizeName = false, }) {
...
export default function transformProps(chartProps) {
    ...
    const { colorScheme, groupby, orient, sort, gap, labelLine, labelType, legendMargin, legendOrientation, legendType, metric = '', numberFormat, showLabels, showLegend, emitFilter, } = {
