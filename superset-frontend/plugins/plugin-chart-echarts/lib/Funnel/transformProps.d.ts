...
import { EchartsFunnelChartProps, EchartsFunnelLabelTypeType, FunnelChartTransformedProps } from './types';
export declare function formatFunnelLabel({ params, labelType, numberFormatter, sanitizeName, }: {
