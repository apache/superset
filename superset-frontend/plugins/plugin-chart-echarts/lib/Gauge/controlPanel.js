...
const config = {
...

  {
    ...
    expanded: true,
    controlSetRows: [
    [___EmotionJSX("h1", { className: "section-header" }, t('General'))],
    [
    {
      name: 'min_val',
      config: {
    ...
    [___EmotionJSX("h1", { className: "section-header" }, t('Axis'))],
    [
    {
      name: 'show_axis_tick',
      config: {
    ...
    [___EmotionJSX("h1", { className: "section-header" }, t('Progress'))],
    [
    {
      name: 'show_progress',
      config: {
    ...
    [___EmotionJSX("h1", { className: "section-header" }, t('Intervals'))],
    [
    {
      name: 'intervals',
      config: {
    ...
    [
    {
      ...
      config: {
        ...
        renderTrigger: true,
        default: DEFAULT_FORM_DATA.intervalColorIndices } }]] }] };const _default =
...
config;export default _default;;(function () {var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;if (!reactHotLoader) {return;}reactHotLoader.register(config, "config", "/Users/evan/GitHub/superset/superset-frontend/plugins/plugin-chart-echarts/src/Gauge/controlPanel.tsx");reactHotLoader.register(_default, "default", "/Users/evan/GitHub/superset/superset-frontend/plugins/plugin-chart-echarts/src/Gauge/controlPanel.tsx");})();;(function () {var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;leaveModule && leaveModule(module);})();