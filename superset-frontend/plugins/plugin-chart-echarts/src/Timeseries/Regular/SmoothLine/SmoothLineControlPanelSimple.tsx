...
export const SmoothLineControlPanel: FC<SmoothLineControlPanelProps> = ({
  onChange,
  value,
  datasource,
  form_data,
...
(SmoothLineControlPanel as any).isModernPanel = true;
  ...
  controlPanelSections: [
    {
      label: null,
      expanded: true,
      controlSetRows: [[SmoothLineControlPanel as any]],
    },
  ],
  controlOverrides: {
    row_limit: {
