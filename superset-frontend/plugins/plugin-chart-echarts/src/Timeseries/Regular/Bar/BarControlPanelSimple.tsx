...
export const BarControlPanel: FC<BarControlPanelProps> = ({
  onChange,
  value,
  datasource,
  form_data,
  ...
  // Helpers for orientation-dependent axis controls
  const isVertical = formValues.orientation === OrientationType.Vertical;
  const isHorizontal = formValues.orientation === OrientationType.Horizontal;
  ...
  const customizeTabContent = (
    <div>
      {/* Chart Orientation */}
      <div style={{ marginBottom: 24 }}>
        <h4>{t('Chart Orientation')}</h4>

        <div style={{ marginBottom: 16 }}>
          <RadioButtonControl
            label={t('Bar orientation')}
            description={t('Orientation of bar chart')}
            value={formValues.orientation || OrientationType.Vertical}
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        {formValues.stack === StackControlsValue.Stack && (
          <div style={{ marginBottom: 16 }}>
            <SelectControl
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        {/* X-axis title controls - show when vertical */}
        {isVertical && (
          <>
            <div style={{ marginBottom: 16 }}>
              <TextControl
            ...
            <div style={{ marginBottom: 16 }}>
              <SelectControl
                ...
                description={t('Margin for axis title')}
                value={formValues.x_axis_title_margin}
                onChange={handleChange('x_axis_title_margin')}
                choices={[
                  [5, '5'],
                  [10, '10'],
                  [15, '15'],
        ...
        {/* X-axis format controls - show when vertical */}
        {isVertical && (
          <>
            <div style={{ marginBottom: 16 }}>
              <SelectControl
        ...
        {/* Y-axis title controls - show when horizontal */}
        {isHorizontal && (
          <>
            <div style={{ marginBottom: 16 }}>
              <TextControl
            ...
            <div style={{ marginBottom: 16 }}>
              <SelectControl
                label={t('Axis Title Margin')}
                description={t('Margin for axis title')}
                value={formValues.y_axis_title_margin}
                onChange={handleChange('y_axis_title_margin')}
                choices={[
                  [5, '5'],
                  [10, '10'],
                  [15, '15'],
            ...
            <div style={{ marginBottom: 16 }}>
              <SelectControl
                ...
                value={formValues.y_axis_title_position || 'Left'}
                onChange={handleChange('y_axis_title_position')}
                choices={[
                  ['Left', t('Left')],
                  ['Top', t('Top')],
                ]}
        ...
        {/* Y-axis format controls - show when horizontal */}
        {isHorizontal && (
          <div style={{ marginBottom: 16 }}>
            <ControlHeader
              label={t('Axis Format')}
              description={t('Format for axis values')}
              hovered
            />
            {(() => {
        ...
        {/* Logarithmic axis - show for value axis based on orientation */}
        {((isVertical && isHorizontal) || isHorizontal) && (
          <div style={{ marginBottom: 16 }}>
            <CheckboxControl
        ...
        {/* Minor split line - show for value axis based on orientation */}
        {((isVertical && isHorizontal) || isHorizontal) && (
          <div style={{ marginBottom: 16 }}>
            <CheckboxControl
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        {/* Y-axis title controls - show when vertical */}
        {isVertical && (
          <>
            <div style={{ marginBottom: 16 }}>
              <TextControl
        ...
        {/* X-axis title controls - show when horizontal */}
        {isHorizontal && (
          <>
            <div style={{ marginBottom: 16 }}>
              <TextControl
        ...
        {/* Y-axis format controls - show when vertical */}
        {isVertical && (
          <div style={{ marginBottom: 16 }}>
            <ControlHeader
        ...
        {/* X-axis format controls - show when horizontal */}
        {isHorizontal && (
          <>
            <div style={{ marginBottom: 16 }}>
              <SelectControl
...
(BarControlPanel as any).isModernPanel = true;
  ...
  controlPanelSections: [
    {
      label: null,
      expanded: true,
      controlSetRows: [[BarControlPanel as any]],
    },
  ],
  controlOverrides: {
    row_limit: {
    ...
    orientation: {
      default: OrientationType.Vertical,
      label: t('Bar orientation'),
      renderTrigger: true,
    },
    show_value: {
