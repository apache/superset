...
export const StepControlPanel: FC<StepControlPanelProps> = ({
  onChange,
  value,
  datasource,
  form_data,
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ marginBottom: 16 }}>
          <SelectControl
            ...
            value={formValues.seriesType || EchartsTimeseriesSeriesType.Start}
...
(StepControlPanel as any).isModernPanel = true;
  ...
  controlPanelSections: [
    {
      label: null,
      expanded: true,
      controlSetRows: [[StepControlPanel as any]],
    },
  ],
  controlOverrides: {
    row_limit: {
