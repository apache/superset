...
interface TreemapControlPanelProps {
...
/**
 * A modern React component-based control panel for Treemap charts.
 */
export const TreemapControlPanel: FC<TreemapControlPanelProps> = ({
  onChange,
  value,
  datasource,
  form_data,
  ...
  const customizeTabContent = (
    <div>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        {/* Show Upper Labels checkbox */}
        <div style={{ marginBottom: 16 }}>
          <CheckboxControl
            label={t('Show Upper Labels')}
            description={t('Show labels when the node has children.')}
            value={formValues.show_upper_labels ?? true}
            onChange={handleChange('show_upper_labels')}
            renderTrigger
            hovered
          />
        </div>
        ...
        <div style={{ marginBottom: 16 }}>
          <SelectControl
            ...
            value={formValues.label_type || 'key_value'}
...
(TreemapControlPanel as any).isModernPanel = true;
  ...
  controlPanelSections: [
    {
      label: null,
      expanded: true,
      controlSetRows: [[TreemapControlPanel as any]],
    },
  ],
  controlOverrides: {
    groupby: {
