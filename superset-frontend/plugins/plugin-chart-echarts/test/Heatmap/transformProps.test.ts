...
describe('Heatmap transformProps', () => {
  ...
  it('should include rank as 4th dimension when normalized is true', () => {
    const dataWithRank = [
  ...
  it('should use 3 dimensions when normalized is false', () => {
  ...
  it('should always hide legend regardless of showLegend setting', () => {
