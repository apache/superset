...
const hasOnlyTextChild = node => node.childNodes.length === 1 &&
    ...
    $container.find('tbody tr').each(function eachRow() {
        $(this)
            ...
            if (hasOnlyTextChild(this)) {
                ...
                const { textContent, sortAttributeValue } = formatCellValue(index, cols, tdText, columnFormats, numberFormat, dateRegex, dateFormatter);
