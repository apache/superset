 ...
 * under the License.
 */
import { SupersetPluginChartSamdtServiceLanes } from '../src';
 ...
 */
describe('superset-plugin-chart-samdt-service-lanes', () => {
  it('exists', () => {
    expect(SupersetPluginChartSamdtServiceLanes).toBeDefined();
  });
});
