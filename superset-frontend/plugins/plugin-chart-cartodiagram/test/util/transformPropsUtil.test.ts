...
describe('transformPropsUtil', () => {
  ...
  test('getWkbColumns gets the WKB columns', () => {
  ...
  test('getWkbColumns gets multiple WKB columns', () => {
    const wkbCol = '0101000020E610000000000000000020400000000000804A40';
  ...
  test('getWkbColumns returns empty array when no WKB column is included', () => {
  ...
  test('getWktColumns gets the WKT columns', () => {
  ...
  test('getWktColumns gets multiple WKT columns', () => {
    const wktCol = 'POINT(8 53)';
  ...
  test('getWktColumns returns empty array when no WKT column is included', () => {
    const columns = ['foo', 'bar'];
  ...
  test('getGeojsonColumns gets the GeoJSON columns', () => {
  ...
  test('getGeojsonColumns gets multiple GeoJSON columns', () => {
  ...
  test('getGeojsonColumns returns empty array when no GeoJSON is included', () => {
    const columns = ['foo', 'bar'];
    const result = getGeojsonColumns(columns);
    expect(result).toHaveLength(0);
  });

  test('createColumnName creates a columns name', () => {
    const columns = ['foo', 'bar'];
    const result = createColumnName(columns, []);
    expect(result).toEqual('foo, bar');
  });

  test('createColumnName ignores items provided by ignoreIdx', () => {
  ...
  test('groupByLocationGenericX groups in the correct count of geometries', () => {
  ...
  test('groupByLocationGenericX groups items by same geometry', () => {
    const result = groupByLocationGenericX(
      groupedTimeseriesChartData,
      groupedTimeseriesParams,
      GeometryFormat.GEOJSON,
  ...
  test('groupByLocation groups in the correct count of geometries', () => {
  ...
  test('groupByLocation groups items by same geometry', () => {
    const geometryColumn = 'geom';
    const result = groupByLocation(nonTimeSeriesChartData, geometryColumn);
  ...
  test('stripGeomFromColnamesAndTypes strips the geom from colnames with geom column', () => {
    const queryData = {
      colnames: ['foo', 'geom'],
      coltypes: [0, 0],
    };
  ...
  test('stripGeomFromColnamesAndTypes strips the geom from colnames with grouped columns', () => {
    const queryData = {
  ...
  test('stripGeomFromColnamesAndTypes strips the geom from colnames with grouped columns without geom', () => {
    const queryData = {
  ...
  test('stripGeomColumnFromLabelMap strips the geom column from label_map', () => {
    const labelMap = {
  ...
  test('getChartConfigs calls the transformProps function for every location', () => {
    getChartConfigs(
      pieChartConfig,
      geomColumn,
      GeometryFormat.GEOJSON,
  ...
  test('getChartConfigs returns a geojson', () => {
  ...
  test('getChartConfigs returns a feature for each location', () => {
    const result = getChartConfigs(
      pieChartConfig,
      geomColumn,
      GeometryFormat.GEOJSON,
  ...
  test('getChartConfigs can handle WKB geometries', () => {
    const result = getChartConfigs(
      pieChartConfig,
      geomColumn,
      GeometryFormat.WKB,
  ...
  test('getChartConfigs can handle WKT geometries', () => {
    const result = getChartConfigs(
      pieChartConfig,
      geomColumn,
      GeometryFormat.WKT,
  ...
  test('parseSelectedChart parses the inline stringified JSON', () => {
