...
export default class PlaySlider extends React.PureComponent {
    ...
    render() {
        ...
        return (<div className="play-slider">
        ...
        <div className="play-slider-scrobbler padded">
          <BootrapSliderWrapper value={range ? values : values[0]} range={range} formatter={this.formatter} change={this.onChange} min={start} max={end} step={step} orientation={orientation} reversed={reversed} disabled={disabled ? 'disabled' : 'enabled'}/>
        </div>
      </div>);
    }
}
...
//# sourceMappingURL=PlaySlider.jsx.map