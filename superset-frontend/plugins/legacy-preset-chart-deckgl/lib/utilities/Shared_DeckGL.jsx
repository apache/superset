...
const sandboxUrl = 'https://github.com/apache/incubator-superset/' +
    'blob/master/superset-frontend/src/modules/sandbox.js';
const jsFunctionInfo = (<div>
...
export const jsDataMutator = {
    ...
    config: jsFunctionControl(t('Javascript data interceptor'), t('Define a javascript function that receives the data array used in the visualization ' +
...
//# sourceMappingURL=Shared_DeckGL.jsx.map