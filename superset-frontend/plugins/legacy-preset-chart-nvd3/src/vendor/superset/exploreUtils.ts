...
export function getURIDirectory(formData: $TSFixMe, endpointType = 'base') {
...
// @ts-expect-error TS(7023): 'getExploreLongUrl' implicitly has return type 'an... Remove this comment to see the full error message
