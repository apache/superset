...
const metadata = new ChartMetadata({
    ...
    description: t('Visualize how a metric changes over time using bars. Add a group by column to visualize group level metrics and how they change over time.'),
