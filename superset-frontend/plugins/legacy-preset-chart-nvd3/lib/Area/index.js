...
const metadata = new ChartMetadata({
    ...
    description: t('A time series chart that visualizes how a related metric from multiple groups vary over time. Each group is visualized using a different color.'),
    exampleGallery: [
