    ...
    controlOverrides: {
        groupby: {
            ...
            mapStateToProps: (state, controlState) => {
                ...
                groupbyProps.canDropValue = (column) => !ensureIsArray(state.controls?.columns?.value).includes(column.column_name);
                return groupbyProps;
            },
            rerender: ['columns'],
        },
        columns: {
            ...
            mapStateToProps: (state, controlState) => {
                ...
                columnsProps.canDropValue = (column) => !ensureIsArray(state.controls?.groupby?.value).includes(column.column_name);
                return columnsProps;
            },
            rerender: ['groupby'],
        },
