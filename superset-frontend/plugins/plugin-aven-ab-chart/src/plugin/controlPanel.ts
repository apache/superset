        ...
        [
          {
            ...
            config: {
              ...
              label: t('AB Groups'),
              description: t('Exactly two groups should be returned'),
            },
          },
        ],
        [
        ...
        [
          {
            ...
            config: {
              ...
              label: t('Step over Step'),
              renderTrigger: true,
              default: true,
              description: t(
                'If unselected all metrics will be over the first metric',
              ),
            },
          },
        ],
