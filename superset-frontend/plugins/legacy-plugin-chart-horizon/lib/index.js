...
const metadata = new ChartMetadata({
    ...
    description: t('Compares how a metric changes over time between different groups. Each group is mapped to a row and change over time is visualized bar lengths and color.'),
