...
export default function DefaultTooltipRenderer({ allSeries, datum, encoder, series = {}, theme = chartTheme, }) {
    return (<TooltipFrame>
      <>
        ...
        <br />
        {series && (<TooltipTable data={allSeries
                ...
                keyColumn: (<>
                    <svg width="12" height="8" style={MARK_STYLE}>
                      <line x2="12" y1="3" y2="3" stroke={stroke} strokeWidth={strokeWidth} strokeDasharray={strokeDasharray}/>
                    </svg>
