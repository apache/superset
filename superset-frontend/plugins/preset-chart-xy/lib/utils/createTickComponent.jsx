...
export default function createTickComponent({ axisWidth, labelAngle, labelFlush, labelOverlap, orient, tickLabels, tickLabelDimensions, tickTextAnchor = 'middle', }) {
    if (labelOverlap === 'rotate' && labelAngle !== 0) {
        ...
        return ({ x, y, formattedValue = '', ...textStyle }) => (<g transform={`translate(${x + xOffset}, ${y + yOffset})`}>
    ...
    if (labelFlush === true || typeof labelFlush === 'number') {
        ...
        return ({ x, y, formattedValue = '', ...textStyle }) => {
            ...
            return (<text x={x + xOffset} y={y} {...textStyle} textAnchor={textAnchor}>
          {formattedValue}
        </text>);
        };
    }
...
//# sourceMappingURL=createTickComponent.jsx.map