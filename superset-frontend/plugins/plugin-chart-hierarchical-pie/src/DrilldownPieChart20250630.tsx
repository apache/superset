...
//     const selectedValue = newPath[newPath.length - 1];

//     if (behaviors?.includes(Behavior.InteractiveChart)) {
//       if (selectedValue) {
//         // Apply filter for selected breadcrumb level
//         hooks?.setDataMask?.({
//           extraFormData: {
//             filters: [
//               {
//                 col: drilldownData?.hierarchy?.[0],
//                 op: 'IN',
//                 val: [selectedValue],
//               },
//             ],
...
//       // Cross-filter: update dashboard filters
//       if (behaviors?.includes(Behavior.InteractiveChart)) {
//         hooks?.setDataMask?.({
//           extraFormData: {
//             filters: [
//               {
//                 col: drilldownData?.hierarchy?.[drilldownPath.length],
//                 op: 'IN',
//                 val: [selectedValue],
//               },
//             ],
...
//       // Drill-down: update local chart state
//       if (
