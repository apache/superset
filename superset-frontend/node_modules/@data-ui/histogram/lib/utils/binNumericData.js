...
exports.default = binNumericData;
...
function binNumericData(_ref) {
  ...
  var binsByIndex = {};
  var histogram = (0, _d3Array.histogram)();
  var extent = (0, _d3Array.extent)(allData, valueAccessor);

  if (binValues) {
    // account for extent of binValues if passed
    var binExtent = (0, _d3Array.extent)(binValues);
    extent = [Math.min(binExtent[0], extent[0]), Math.max(binExtent[1], extent[1])];
  }

  var scale = (0, _d3Scale.scaleLinear)().domain(extent).nice(binCount);
