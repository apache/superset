...
exports.default = findClosestDatums;

var _react = require("react");

var _event = require("@vx/event");

var _findClosestDatum = _interopRequireDefault(require("./findClosestDatum"));
...
function findClosestDatums(_ref) {
  ...
  var _localPoint = (0, _event.localPoint)(gElement, event),
  ...
  _react.Children.forEach(children, function (Child) {
    ...
    if (name === 'AreaDifferenceSeries') {
      _react.Children.forEach(Child.props.children, function (NestedChild) {
  ...
  flatSeriesChildren.forEach(function (Child, childIndex) {
    if (!Child.props.disableMouseEvents) {
      ...
      var datum = (0, _findClosestDatum.default)({
        data: data,
        getX: getX,
        xScale: xScale,
        event: event,
