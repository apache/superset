...
const metadata = new _chart.ChartMetadata({
  ...
  description: '',
  name: (0, _translation.t)('Heatmap'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class HeatmapChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactHeatmap.js'))),
      metadata,
