...
const metadata = new _chart.ChartMetadata({
  ...
  description: '',
  name: (0, _translation.t)('Sankey Diagram'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class SankeyChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactSankey.js'))),
      metadata,
