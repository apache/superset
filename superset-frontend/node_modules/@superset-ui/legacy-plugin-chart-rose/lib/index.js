...
const metadata = new _chart.ChartMetadata({
  description: '',
  name: (0, _translation.t)('Nightingale Rose Chart'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class RoseChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactRose.js'))),
      metadata,
