...
const metadata = new _chart.ChartMetadata({
  ...
  description: '',
  name: (0, _translation.t)('Treemap'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class TreemapChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactTreemap.js'))),
      metadata,
