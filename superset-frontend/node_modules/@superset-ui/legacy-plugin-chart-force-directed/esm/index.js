...
const metadata = new _chart.ChartMetadata({
  ...
  description: '',
  name: (0, _translation.t)('Force-directed Graph'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class ForceDirectedChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactForceDirected.js'))),
      metadata,
...
exports.default = ForceDirectedChartPlugin;