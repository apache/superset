...
const metadata = new _chart.ChartMetadata({
  ...
  description: '',
  name: (0, _translation.t)('Country Map'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class CountryMapChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactCountryMap.js'))),
      metadata,
