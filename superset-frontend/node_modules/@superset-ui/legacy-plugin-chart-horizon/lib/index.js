...
const metadata = new _chart.ChartMetadata({
  ...
  description: '',
  name: (0, _translation.t)('Horizon Chart'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class HorizonChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./HorizonChart'))),
      metadata,
