...
const metadata = new _chart.ChartMetadata({
  ...
  description: '',
  name: (0, _translation.t)('Event Flow'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class EventFlowChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./EventFlow'))),
      loadTransformProps: () => Promise.resolve().then(() => _interopRequireWildcard(require('./transformProps.js'))),
      metadata,
