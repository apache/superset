...
const metadata = new _chart.ChartMetadata({
  description: '',
  name: (0, _translation.t)('Big Number with Trendline'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class BigNumberChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./BigNumber'))),
      metadata,
...
exports.default = BigNumberChartPlugin;