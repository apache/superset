...
const metadata = new _chart.ChartMetadata({
  ...
  name: (0, _translation.t)('IFrame'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class IframeChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./Iframe'))),
      metadata,
...
exports.default = IframeChartPlugin;