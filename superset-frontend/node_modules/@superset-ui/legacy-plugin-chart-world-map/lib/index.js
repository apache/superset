...
const metadata = new _chart.ChartMetadata({
  ...
  description: '',
  name: (0, _translation.t)('World Map'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class WorldMapChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactWorldMap.js'))),
      metadata,
