...
const metadata = new _chart.ChartMetadata({
  ...
  description: '',
  name: (0, _translation.t)('Parallel Coordinates'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class ParallelCoordinatesChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactParallelCoordinates.js'))),
      metadata,
