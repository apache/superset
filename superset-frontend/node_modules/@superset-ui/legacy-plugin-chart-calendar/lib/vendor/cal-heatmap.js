...
var CalHeatMap = function CalHeatMap() {
  'use strict';

  var self = this;
  self.tip = (0, _d3Tip.default)().attr('class', 'd3-tip').direction('n').offset([-5, 0]).html(d => "\n      " + self.options.timeFormatter(d.t) + ": <strong>" + self.options.valueFormatter(d.v) + "</strong>\n    ");
  self.legendTip = (0, _d3Tip.default)().attr('class', 'd3-tip').direction('n').offset([-5, 0]).html(d => self.options.valueFormatter(d));
  ...
  this._domainType = {
    min: {
      ...
      extractUnit: function extractUnit(d) {
    ...
    hour: {
      name: 'hour',
      level: 20,
      maxItemNumber: function maxItemNumber(d) {
      ...
      defaultRowNumber: 6,
      defaultColumnNumber: function defaultColumnNumber(d) {
        switch (self.options.domain) {
          case 'day':
            return 4;
...
CalHeatMap.prototype = {
   ...
   */
  expandDateSetting: function expandDateSetting(value) {
    'use strict';
   ...
   * @return String
   */
  formatStringWithObject: function formatStringWithObject(formatted, args) {
    'use strict';
   ...
   */
  triggerEvent: function triggerEvent(eventName, successArgs, skip) {
    'use strict';
   ...
   */
  onClick: function onClick(d, itemNb) {
    'use strict';
   ...
   */
  afterLoadPreviousDomain: function afterLoadPreviousDomain(start) {
    'use strict';
   ...
   * @param  Date    end    Domain end date
   */
  afterLoadNextDomain: function afterLoadNextDomain(start) {
    'use strict';
   ...
   */
  onMinDomainReached: function onMinDomainReached(reached) {
    'use strict';
   ...
   */
  onMaxDomainReached: function onMaxDomainReached(reached) {
    'use strict';

    this._maxDomainReached = reached;
    return this.triggerEvent('onMaxDomainReached', [reached]);
  },
  checkIfMinDomainIsReached: function checkIfMinDomainIsReached(date, upperBound) {
    'use strict';
  ...
  checkIfMaxDomainIsReached: function checkIfMaxDomainIsReached(date, lowerBound) {
    'use strict';
  ...
  getSubDomainTitle: function getSubDomainTitle(d) {
    'use strict';
   ...
   */
  loadNextDomain: function loadNextDomain(n) {
    'use strict';
   ...
   */
  loadPreviousDomain: function loadPreviousDomain(n) {
    'use strict';
   ...
   */
  maxDomainIsReached: function maxDomainIsReached(datetimestamp) {
    'use strict';
   ...
   */
  minDomainIsReached: function minDomainIsReached(datetimestamp) {
    'use strict';
   ...
   */
  getDomainKeys: function getDomainKeys() {
    'use strict';
  ...
  // POSITIONNING                                //
  // =========================================================================//
  positionSubDomainX: function positionSubDomainX(d) {
    'use strict';
  ...
  positionSubDomainY: function positionSubDomainY(d) {
    'use strict';
  ...
  getSubDomainColumnNumber: function getSubDomainColumnNumber(d) {
    'use strict';
  ...
  getSubDomainRowNumber: function getSubDomainRowNumber(d) {
    'use strict';
   ...
   */
  getHighlightClassName: function getHighlightClassName(d) {
    'use strict';
  ...
  dateIsEqual: function dateIsEqual(dateA, dateB) {
    'use strict';
   ...
   * @returns {boolean}
   */
  dateIsLessThan: function dateIsLessThan(dateA, dateB) {
    'use strict';
   ...
   */
  getMonthWeekNumber: function getMonthWeekNumber(d) {
    'use strict';
   ...
   */
  getWeekNumberInYear: function getWeekNumberInYear(d) {
    'use strict';
   ...
   */
  getDayCountInMonth: function getDayCountInMonth(d) {
    'use strict';
   ...
   */
  getDayCountInYear: function getDayCountInYear(d) {
    'use strict';
   ...
   */
  getWeekDay: function getWeekDay(d) {
    'use strict';
   ...
   */
  getEndOfMonth: function getEndOfMonth(d) {
    'use strict';
   ...
   * @return Date
   */
  jumpDate: function jumpDate(date, count, step) {
    'use strict';
   ...
   */
  getMinuteDomain: function getMinuteDomain(d, range) {
    'use strict';
   ...
   */
  getHourDomain: function getHourDomain(d, range) {
    'use strict';
   ...
   */
  getDayDomain: function getDayDomain(d, range) {
    'use strict';
   ...
   * @return array  An array of weeks
   */
  getWeekDomain: function getWeekDomain(d, range) {
    'use strict';
   ...
   */
  getMonthDomain: function getMonthDomain(d, range) {
    'use strict';
   ...
   * @return array  An array of hours
   */
  getYearDomain: function getYearDomain(d, range) {
    'use strict';
   ...
   */
  getDomain: function getDomain(date, range) {
    'use strict';
  ...
  /* jshint maxcomplexity: false */
  getSubDomain: function getSubDomain(date) {
    'use strict';
    ...
    var computeDaySubDomainSize = function computeDaySubDomainSize(date, domain) {
      switch (domain) {
        case 'year':
    ...
    var computeMinSubDomainSize = function computeMinSubDomainSize(date, domain) {
      switch (domain) {
        case 'hour':
          return 60;
    ...
    var computeHourSubDomainSize = function computeHourSubDomainSize(date, domain) {
      switch (domain) {
        case 'day':
          return 24;
    ...
    var computeWeekSubDomainSize = function computeWeekSubDomainSize(date, domain) {
      if (domain === 'month') {
   ...
   */
  getNextDomain: function getNextDomain(n) {
    'use strict';
   ...
   * @return Date The start date of the wanted domain
   */
  getPreviousDomain: function getPreviousDomain(n) {
    'use strict';
   ...
   */
  getDatas: function getDatas(source, startDate, endDate, callback, afterLoad, updateMode) {
    'use strict';
    ...
    var _callback = function _callback(error, data) {
      if (afterLoad !== false) {
   ...
   * @return void
   */
  parseDatas: function parseDatas(data, updateMode, startDate, endDate) {
    'use strict';
    ...
    var extractTime = function extractTime(d) {
      return d.t;
    };
    /*jshint forin:false */
  ...
  parseURI: function parseURI(str, startDate, endDate) {
  ...
  interpretCSV: function interpretCSV(data) {
    'use strict';
   ...
   */
  jumpTo: function jumpTo(date, reset) {
    'use strict';
   ...
   */
  update: function update(dataSource, afterLoad, updateMode) {
    'use strict';
  ...
  getSVG: function getSVG() {
    ...
    var filterStyles = function filterStyles(attribute, property, value) {
...
var DomainPosition = function DomainPosition() {
  'use strict';
...
var Legend = function Legend(calendar) {
  'use strict';
