...
const metadata = new _chart.ChartMetadata({
  ...
  description: '',
  name: (0, _translation.t)('Calendar Heatmap'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class CalendarChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactCalendar'))),
      metadata,
...
exports.default = CalendarChartPlugin;