...
const metadata = new _chart.ChartMetadata({
  ...
  description: (0, _translation.t)('A bar chart where the x axis is time'),
  name: (0, _translation.t)('Bar Chart'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class DistBarChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
...
exports.default = DistBarChartPlugin;