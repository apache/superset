...
import sandboxedEval from '../../utils/sandbox'; // eslint-disable-next-line import/extensions

import getPointsFromPolygon from '../../utils/getPointsFromPolygon'; // eslint-disable-next-line import/extensions
...
function setTooltipContent(formData) {
  return o => {
    ...
    }, o.object.name && React.createElement(TooltipRow, {
      label: "name: ",
      value: "" + o.object.name
    }), o.object[formData.line_column] && React.createElement(TooltipRow, {
