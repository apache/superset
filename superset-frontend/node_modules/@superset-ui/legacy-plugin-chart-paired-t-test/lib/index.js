...
const metadata = new _chart.ChartMetadata({
  description: '',
  name: (0, _translation.t)('Paired t-test Table'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class PairedTTestChartPlugin extends _chart.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./PairedTTest'))),
      metadata,
...
exports.default = PairedTTestChartPlugin;