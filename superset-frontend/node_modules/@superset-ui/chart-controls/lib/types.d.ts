...
declare type AnyDict = Record<string, unknown>;
interface Action {
    type: string;
}
...
export declare type ControlState<T extends InternalControlType | unknown = InternalControlType, O extends SelectOption = SelectOption> = ControlConfig<T, O> & ExtraControlProps;
...
declare type SelectControlType = 'SelectControl' | 'SelectAsyncControl' | 'SelectControl' | 'MetricsControl' | 'FixedOrMetricControl' | 'AdhocFilterControl' | 'FilterBoxItemControl' | 'MetricsControlVerifiedOptions' | 'SelectControlVerifiedOptions' | 'AdhocFilterControlVerifiedOptions';
interface FilterOption<T extends SelectOption> {
    label: string;
    value: string;
    data: T;
}
export interface SelectControlConfig<O extends SelectOption = SelectOption, T extends SelectControlType = SelectControlType> extends BaseControlConfig<T> {
    clearable?: boolean;
    freeForm?: boolean;
    multi?: boolean;
    valueKey?: string;
 ...
 * Custom controls
 * --------------------------------------------- */
export declare type CustomComponentControlConfig<P = unknown> = BaseControlConfig<InternalControlType | React.ComponentType<P>> & Omit<P, 'onChange' | 'hovered'>;
export declare type ControlConfig<T extends InternalControlType | unknown = InternalControlType, O extends SelectOption = SelectOption> = T extends InternalControlType ? SharedControlConfig<T, O> : CustomComponentControlConfig<T>;
/** --------------------------------------------
...
export declare type ControlSetItem = SharedControlAlias | OverrideSharedControlItem | CustomControlItem | ReactElement | null;
