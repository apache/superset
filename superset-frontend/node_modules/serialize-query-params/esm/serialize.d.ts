 ...
 * @return {String} the encoded date
 */
export declare function encodeDateTime(date: Date | null | undefined): string | undefined;
/**
 ...
 * @return {Date} parsed date
 */
export declare function decodeDateTime(input: string | string[] | null | undefined): Date | undefined;
/**
