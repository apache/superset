...
module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!d3|d3-array|remark-gfm|markdown-table|micromark-*.|decode-named-character-reference|character-entities|mdast-util-*.|unist-util-*.|ccount|escape-string-regexp)',
  ],
  globals: {
    __DEV__: true,
    caches: true,
