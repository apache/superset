...
module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!d3-(interpolate|color|format)|remark-gfm|markdown-table|micromark-*.|decode-named-character-reference|character-entities|mdast-util-*.|unist-util-*.|ccount|escape-string-regexp|nanoid|@rjsf/*.|sinon|echarts|zrender)',
  ],
  globals: {
    __DEV__: true,
    caches: true,
