...
import {
  DEFAULT_FORM_DATA,
  PluginFilterCustomDateFilterChartProps,
  PluginFilterCustomDateFilterQueryFormData,
} from './types';

export default function transformProps(
  chartProps: PluginFilterCustomDateFilterChartProps,
) {
  const {
    formData,
    height,
  ...
  const newFormData = {
    ...DEFAULT_FORM_DATA,
    ...(formData as PluginFilterCustomDateFilterQueryFormData),
  };
  const {
    setDataMask = noOp,
