...
import {
  DEFAULT_FORM_DATA,
  PluginFilterCustomFilterChartProps,
  PluginFilterCustomFilterQueryFormData,
} from './types';

export default function transformProps(
  chartProps: PluginFilterCustomFilterChartProps,
) {
  const {
    formData,
    height,
  ...
  const newFormData = {
    ...DEFAULT_FORM_DATA,
    ...(formData as PluginFilterCustomFilterQueryFormData),
  };
  const {
    setDataMask = noOp,
