...
import AdhocFilterPlugin from './index';
import transformProps from './transformProps';

new AdhocFilterPlugin().configure({ key: 'filter_adhoc' }).register();

getChartTransformPropsRegistry().registerValue('filter_adhoc', transformProps);
