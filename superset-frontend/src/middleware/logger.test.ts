...
describe('logger middleware', () => {
  ...
  it('should POST an event to /superset/log/ when called', () => {
    ...
    // @ts-expect-error TS(2339): Property 'callCount' does not exist on type '<T ex... Remove this comment to see the full error message
    expect(SupersetClient.post.callCount).toBe(1);
    // @ts-expect-error TS(2339): Property 'getCall' does not exist on type '<T exte... Remove this comment to see the full error message
