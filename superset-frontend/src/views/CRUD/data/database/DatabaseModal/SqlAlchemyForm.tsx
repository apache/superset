...
import { StyledInputContainer } from 'src/views/CRUD/data/database/DatabaseModal/styles';
...
const SqlAlchemyTab = ({
  ...
  onInputChange: React.EventHandler<React.SyntheticEvent<HTMLInputElement>>;
  testConnection: React.EventHandler<React.MouseEvent<HTMLElement>>;
