...
import DatabaseSelectorPopover, {
  DatabaseSelectorPopoverProps,
} from 'src/SqlLab/components/DatabaseSelectorPopover';
import {
  table,
  initialState,
  defaultQueryEditor,
...
const renderAndWait = (
  props: DatabaseSelectorPopoverProps,
  store?: Store,
  initialState?: RootState,
) =>
  waitFor(() =>
    render(<DatabaseSelectorPopover {...props} />, {
      useRedux: true,
      initialState,
      ...(store && { store }),
    }),
