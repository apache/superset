...
describe('async actions', () => {
  ...
  describe('saveQuery', () => {
    ...
    it('posts to the correct url', () => {
      ...
      // @ts-expect-error TS(2345): Argument of type '(dispatch: $TSFixMe) => Promise<... Remove this comment to see the full error message
  ...
  describe('popSavedQuery', () => {
    ...
    it('calls API endpint with correct params', async () => {
      // @ts-expect-error TS(2345): Argument of type '{ json: { result: { catalog: nul... Remove this comment to see the full error message
        ...
        const expectedActions = [
          {
            ...
            queryEditor: {
              ...
              autorun: false,
              queryLimit:
                // @ts-expect-error TS(2339): Property 'queryLimit' does not exist on type '{ ve... Remove this comment to see the full error message
  ...
  describe('backend sync', () => {
    ...
    beforeEach(() => {
      ...
      isFeatureEnabled.mockImplementation(
        (feature: $TSFixMe) => feature === 'SQLLAB_BACKEND_PERSISTENCE',
      );
    });
      ...
      it('dispatches table state from unsaved change', () => {
        ...
        const store = mockStore({
          ...
          sqlLab: {
            ...initialState.sqlLab,
            unsavedQueryEditor: {
              // @ts-expect-error TS(2339): Property 'id' does not exist on type '{ name: stri... Remove this comment to see the full error message
              id: query.id,
              dbId: expectedDbId,
            },
          },
        ...
        return (
          store
            ...
            .then(() => {
              ...
              expect(fetchMock.calls(updateTableSchemaEndpoint)).toHaveLength(
                2,
              );
            })
        );
