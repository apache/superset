...
describe('getChartDataPayloads', () => {
  ...
  test('returns empty object when charts with state converters are not found', async () => {
  ...
  test('generates payloads for charts with state converters', async () => {
    const mockPayload = {
      queries: [{ some: 'query' }],
    };
  ...
  test('filters by specific chartId when provided', async () => {
    const mockPayload = {
      queries: [{ some: 'query' }],
    };
  ...
  test('returns error object for specific chartId not found', async () => {
    jest
      .spyOn(chartStateConverter, 'hasChartStateConverter')
      .mockReturnValue(false);
  ...
  test('handles errors during payload generation gracefully', async () => {
    const mockPayload = {
      queries: [{ some: 'query' }],
    };
  ...
  test('merges baseOwnState with converted chart state', async () => {
    const mockPayload = {
      queries: [{ some: 'query' }],
    };
