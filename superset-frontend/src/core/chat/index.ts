...
export const chat: typeof chatApi = {
  ...
  getClientTools: provider.getClientTools.bind(provider),
  executeClientTool: provider.executeClientTool.bind(provider),
  onDidChangeClientTools: provider.onDidChangeClientTools,
};
