...
describe('DragDroppable', () => {
  ...
  function setup(overrideProps = {}) {
    const defaultChildren = (provided: $TSFixMe) => (
  ...
  it('should call its child function with "dropIndicatorProps" dependent on editMode and isDraggingOver', () => {
    ...
    render(
      <MockDragDroppable
        {...props}
        // @ts-expect-error TS(2322): Type '{ children: Mock<Element, [provided: any], a... Remove this comment to see the full error message
        editMode
        isDraggingOver
        // @ts-expect-error TS(2554): Expected 2-3 arguments, but got 1.
  ...
  it('should call onDropIndicatorChange when appropriate', () => {
    ...
    rerender(
      <DragDroppable
        {...props}
        // @ts-expect-error TS(2322): Type '{ component: { type: any; id: string; childr... Remove this comment to see the full error message
        component={newComponentFactory(TAB_TYPE)}
