...
export const dragConfig = [
  ...
  function dragStateToProps(connect: $TSFixMe, monitor: $TSFixMe) {
    return {
...
export const dropConfig = [
  TYPE,
  {
    canDrop(props: $TSFixMe) {
      return !props.disableDragDrop;
    },
    hover(props: $TSFixMe, monitor: $TSFixMe, component: $TSFixMe) {
    ...
    drop(props: $TSFixMe, monitor: $TSFixMe, component: $TSFixMe) {
  ...
  function dropStateToProps(connect: $TSFixMe, monitor: $TSFixMe) {
    return {
