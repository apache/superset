...
const TabTitleContainer = styled.div`
  // @ts-expect-error TS(2339): Property 'isHighlighted' does not exist on type '{... Remove this comment to see the full error message
...
const Tab = (props: $TSFixMe) => {
  ...
  const renderTabContent = useCallback(() => {
    ...
    return (
      <div className="dashboard-component-tabs-content">
        ...
        {tabComponent.children.map(
          (componentId: $TSFixMe, componentIndex: $TSFixMe) => (
  ...
  const renderTabChild = useCallback(
    ({ dropIndicatorProps, dragSourceRef, draggingTabOnTab }) => {
      ...
      return (
        <TabTitleContainer
          // @ts-expect-error TS(2322): Type '{ children: any[]; isHighlighted: any; class... Remove this comment to see the full error message
  ...
  const renderTab = useCallback(() => {
    ...
    return (
      <DragDroppable
        // @ts-expect-error TS(2322): Type '{ children: ({ dropIndicatorProps, dragSourc... Remove this comment to see the full error message
        component={component}
