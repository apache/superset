...
describe('Markdown', () => {
  ...
  it('should call updateComponents when switching from edit to preview with changes', async () => {
    ...
    // @ts-expect-error TS(2339): Property 'container' does not exist on type 'undef... Remove this comment to see the full error message
  ...
  it('should resize editor when width changes', async () => {
    // @ts-expect-error TS(2339): Property 'rerender' does not exist on type 'undefi... Remove this comment to see the full error message
