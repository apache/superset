...
function setup(overrideProps: $TSFixMe, overrideState: $TSFixMe) {
...
test.skip('should call changeFilter when ChartContainer calls changeFilter', () => {
  ...
  // @ts-expect-error TS(2339): Property 'instance' does not exist on type 'Render... Remove this comment to see the full error message
  wrapper.instance().changeFilter();
  // @ts-expect-error TS(2339): Property 'callCount' does not exist on type 'Mock<... Remove this comment to see the full error message
