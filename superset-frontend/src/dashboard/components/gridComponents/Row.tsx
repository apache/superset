...
const emptyRowContentStyles = (theme: $TSFixMe) => css`
  position: absolute;
  width: 100%;
  height: 100%;
  display: flex;
...
const Row = (props: $TSFixMe) => {
  ...
  useEffect(() => {
    let observerEnabler: $TSFixMe;
    let observerDisabler: $TSFixMe;
    if (
    ...
    ({ dragSourceRef }) => (
      ...
      >
        ...
        >
          ...
          {rowItems.length > 0 &&
            rowItems.map((componentId: $TSFixMe, itemIndex: $TSFixMe) => (
              <Fragment key={componentId}>
                <DashboardComponent
                  ...
                  depth={depth + 1}
                  index={itemIndex}
                  // @ts-expect-error TS(2322): Type '{ key: any; id: any; parentId: any; depth: a... Remove this comment to see the full error message
