...
class Header extends PureComponent {
  handleChangeBackground: $TSFixMe;

  handleChangeSize: $TSFixMe;

  handleChangeText: $TSFixMe;
  ...
  handleUpdateMeta(metaKey: $TSFixMe, nextValue: $TSFixMe) {
  ...
  render() {
    ...
    const {
      ...
      editMode,
      // @ts-expect-error TS(2339): Property 'embeddedMode' does not exist on type 'Re... Remove this comment to see the full error message
      embeddedMode,
    } = this.props;
