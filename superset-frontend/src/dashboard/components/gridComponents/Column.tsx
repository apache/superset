...
const emptyColumnContentStyles = (theme: $TSFixMe) => css`
...
const Column = (props: $TSFixMe) => {
  ...
  const renderChild = useCallback(
    ({ dragSourceRef }) => (
      // @ts-expect-error TS(2741): Property 'heightMultiple' is missing in type '{ ch... Remove this comment to see the full error message
      <ResizableContainer
      ...
      >
        ...
        >
          ...
          <ColumnStyles
            ...
            // @ts-expect-error TS(2322): Type '{ children: any[]; className: string; editMo... Remove this comment to see the full error message
            editMode={editMode}
          >
            {editMode && (
              <Droppable
                ...
                // @ts-expect-error TS(2322): Type '{ children: ({ dropIndicatorProps }: any) =>... Remove this comment to see the full error message
                depth={depth}
                index={0}
                orientation="column"
            ...
            {columnItems.length === 0 ? (
              ...
              columnItems.map((componentId: $TSFixMe, itemIndex: $TSFixMe) => (
