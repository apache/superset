                ...
                if (messageObject.info && messageObject.dataType) {
                    ...
                    if (
                        ...
                        if (widgetUrlQueryMode === 'preview') {
                            ...
                            widgetUrlQuery.set('dimensions_column', messageData.dimensions_column);
        ...
        if (ikigaiOrigin) {
            ...
            if (markdownSource) {
                ...
                const data_series = iframeSrcUrl.searchParams.get('data_series')
                    ...
                    : '';
                const dimensions_column = iframeSrcUrl.searchParams.get('dimensions_column')
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div
                                    ref={dragSourceRef}
                                    className="dashboard-component-inner dashboard-interactiveforecast" //change this?
