...
describe('Dashboard', () => {
  ...
  const renderDashboard = (overrideProps = {}) =>
    render(
      // @ts-expect-error TS(2739): Type '{ loading: false; }' is missing the followin... Remove this comment to see the full error message
  ...
  describe('layout changes', () => {
    ...
    it('should call addSliceToDashboard if a new slice is added to the layout', () => {
      ...
      rerender(
        // @ts-expect-error TS(2739): Type '{ loading: false; }' is missing the followin... Remove this comment to see the full error message
        <PluginContext.Provider value={{ loading: false }}>
          // @ts-expect-error TS(2322): Type '{ children: Element; layout: { 1001: { type:... Remove this comment to see the full error message
  ...
  describe('filter updates', () => {
    it('should not call refresh when in editMode', () => {
      ...
      rerender(
        ...
        <PluginContext.Provider value={{ loading: false }}>
          <Dashboard
            {...props}
            // @ts-expect-error TS(2322): Type '{ children: Element; activeFilters: { '1_reg... Remove this comment to see the full error message
          ...
          <Dashboard
            ...
            activeFilters={{
              ...
              ...getAllActiveFilters({
                ...
                // @ts-expect-error TS(2322): Type '{ "NATIVE_FILTER-p4LImrSgA": { id: string[];... Remove this comment to see the full error message
    ...
    it('should call refresh if a filter is added', () => {
      ...
      rerender(
        // @ts-expect-error TS(2739): Type '{ loading: false; }' is missing the followin... Remove this comment to see the full error message
        <PluginContext.Provider value={{ loading: false }}>
          // @ts-expect-error TS(2322): Type '{ children: Element; activeFilters: { gender... Remove this comment to see the full error message
    ...
    it('should call refresh if a filter is removed', () => {
      ...
      rerender(
        ...
        <PluginContext.Provider value={{ loading: false }}>
          <Dashboard
            {...props}
            // @ts-expect-error TS(2322): Type '{ children: Element; activeFilters: {}; refr... Remove this comment to see the full error message
            activeFilters={{}}
    ...
    it('should call refresh with multiple chart ids', () => {
      ...
      rerender(
        // @ts-expect-error TS(2739): Type '{ loading: false; }' is missing the followin... Remove this comment to see the full error message
        <PluginContext.Provider value={{ loading: false }}>
          // @ts-expect-error TS(2322): Type '{ children: Element; activeFilters: { '2_cou... Remove this comment to see the full error message
          <Dashboard {...props} activeFilters={newFilters}>
            <ChildrenComponent />
          </Dashboard>
        </PluginContext.Provider>,
    ...
    it('should call refresh if a filter scope is changed', () => {
      ...
      rerender(
        // @ts-expect-error TS(2739): Type '{ loading: false; }' is missing the followin... Remove this comment to see the full error message
        <PluginContext.Provider value={{ loading: false }}>
          // @ts-expect-error TS(2322): Type '{ children: Element; activeFilters: { '3_cou... Remove this comment to see the full error message
          <Dashboard {...props} activeFilters={newFilters}>
            <ChildrenComponent />
          </Dashboard>
        </PluginContext.Provider>,
