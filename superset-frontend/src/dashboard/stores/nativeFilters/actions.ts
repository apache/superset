...
/**
 * Imperative domain API for native filters, for use outside render (handlers,
 * effects, non-React modules). Delegates to the store's own actions so
 * middleware stays applied; for reactive reads in render, use `./hooks`.
 */
