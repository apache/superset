...
import { DASHBOARD_HEADER_ID, UNDO_LIMIT } from 'src/dashboard/util/constants';
  ...
  devtools(
    subscribeWithSelector(
      temporal(
        ...
        {
          limit: UNDO_LIMIT + 2, // +2 to match redux-undo behavior
          // Only the layout is undoable; a history entry is recorded solely when
          // it changes (the store's other members are stable action functions).
