...
const lazyFunction = (f: $TSFixMe) => () => f().apply(this, arguments);
...
const parentShape = {
  ...
  children: PropTypes.arrayOf(
    PropTypes.oneOfType([
      // @ts-expect-error TS(2345): Argument of type '() => any' is not assignable to ... Remove this comment to see the full error message
