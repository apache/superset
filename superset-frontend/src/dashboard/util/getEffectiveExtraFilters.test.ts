...
describe('getEffectiveExtraFilters', () => {
  it('should create valid filters', () => {
    const result = getEffectiveExtraFilters({
      gender: ['girl'],
      // @ts-expect-error TS(2322): Type 'null' is not assignable to type 'DataRecordV... Remove this comment to see the full error message
      name: null,
      // @ts-expect-error TS(2322): Type 'string' is not assignable to type 'DataRecor... Remove this comment to see the full error message
