...
export const findAffectedChartsByScope = ({
  ...
  if (layout[child].type === CHART_TYPE) {
    ...
    if (isChartAffectedByDataset(charts, chartId, nativeFilters, filterId)) {
...
export const isChartAffectedByDataset = (
  charts: Charts,
  chartId: number,
  nativeFilters: Filters,
