...
describe('getChartIdsFromLayout', () => {
  ...
  it('should encode filters', () => {
    // @ts-expect-error TS(2345): Argument of type '{ pathname: string; filters: { '... Remove this comment to see the full error message
  ...
  it('should encode filters with missing filters', () => {
    const urlWithStandalone = getDashboardUrl({
      pathname: 'path',
      // @ts-expect-error TS(2322): Type 'undefined' is not assignable to type 'JsonOb... Remove this comment to see the full error message
      filters: undefined,
      standalone: DashboardStandaloneMode.HideNav,
    });
    expect(urlWithStandalone).toBe(
  ...
  it('should preserve unknown filters', () => {
    ...
    // @ts-expect-error TS(2345): Argument of type '() => { location: { origin: stri... Remove this comment to see the full error message
    ...
    // @ts-expect-error TS(2345): Argument of type '{ pathname: string; standalone: ... Remove this comment to see the full error message
    const urlWithStandalone = getDashboardUrl({
      pathname: 'path',
      standalone: DashboardStandaloneMode.HideNav,
    });
  ...
  it('should process native filters key', () => {
    ...
    // @ts-expect-error TS(2345): Argument of type '{ pathname: string; }' is not as... Remove this comment to see the full error message
