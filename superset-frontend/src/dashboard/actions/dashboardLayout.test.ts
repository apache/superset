...
describe('dashboardLayout actions', () => {
  ...
  afterEach(() => {
    // @ts-expect-error TS(2339): Property 'restore' does not exist on type '(compon... Remove this comment to see the full error message
  ...
  describe('updateComponents', () => {
    it('should dispatch an updateLayout action', () => {
      ...
      // @ts-expect-error TS(2339): Property 'callCount' does not exist on type '(comp... Remove this comment to see the full error message
