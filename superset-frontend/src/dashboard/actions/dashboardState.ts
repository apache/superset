...
export function setUnsavedChanges(hasUnsavedChanges: $TSFixMe) {
  return { type: SET_UNSAVED_CHANGES, payload: { hasUnsavedChanges } };
}

export const ADD_SLICE = 'ADD_SLICE';
export function addSlice(slice: $TSFixMe) {
  return { type: ADD_SLICE, slice };
}

export const REMOVE_SLICE = 'REMOVE_SLICE';
export function removeSlice(sliceId: $TSFixMe) {
  return { type: REMOVE_SLICE, sliceId };
}

export const TOGGLE_FAVE_STAR = 'TOGGLE_FAVE_STAR';
export function toggleFaveStar(isStarred: $TSFixMe) {
  return { type: TOGGLE_FAVE_STAR, isStarred };
}

export function fetchFaveStar(id: $TSFixMe) {
  return function fetchFaveStarThunk(dispatch: $TSFixMe) {
...
export function saveFaveStar(id: $TSFixMe, isStarred: $TSFixMe) {
  return function saveFaveStarThunk(dispatch: $TSFixMe) {
...
export function togglePublished(isPublished: $TSFixMe) {
  return { type: TOGGLE_PUBLISHED, isPublished };
}

export function savePublished(id: $TSFixMe, isPublished: $TSFixMe) {
  return function savePublishedThunk(dispatch: $TSFixMe) {
...
export function toggleExpandSlice(sliceId: $TSFixMe) {
  return { type: TOGGLE_EXPAND_SLICE, sliceId };
}

export const UPDATE_CSS = 'UPDATE_CSS';
export function updateCss(css: $TSFixMe) {
  return { type: UPDATE_CSS, css };
}

export const SET_EDIT_MODE = 'SET_EDIT_MODE';
export function setEditMode(editMode: $TSFixMe) {
...
export function onSave(lastModifiedTime: $TSFixMe) {
...
export function setRefreshFrequency(
  refreshFrequency: $TSFixMe,
  isPersistent = false,
) {
  return { type: SET_REFRESH_FREQUENCY, refreshFrequency, isPersistent };
}

export function saveDashboardRequestSuccess(lastModifiedTime: $TSFixMe) {
...
export function setOverrideConfirm(overwriteConfirmMetadata: $TSFixMe) {
  return {
...
export function saveDashboardRequest(
  ...
  return (dispatch: $TSFixMe, getState: $TSFixMe) => {
    ...
    const hasId = (item: $TSFixMe) => item.id !== undefined;
    ...
    const onCopySuccess = (response: $TSFixMe) => {
    ...
    const onUpdateSuccess = (response: $TSFixMe) => {
    ...
    const onError = async (response: $TSFixMe) => {
...
export function addSliceToDashboard(id: $TSFixMe) {
  return (dispatch: $TSFixMe, getState: $TSFixMe) => {
...
export function removeSliceFromDashboard(id: $TSFixMe) {
  return (dispatch: $TSFixMe) => {
...
export function setColorScheme(colorScheme: $TSFixMe) {
  return { type: SET_COLOR_SCHEME, colorScheme };
}

export const SET_DIRECT_PATH = 'SET_DIRECT_PATH';
export function setDirectPathToChild(path: $TSFixMe) {
...
function findTabsToRestore(
  tabId: $TSFixMe,
  prevTabId: $TSFixMe,
  dashboardState: $TSFixMe,
  dashboardLayout: $TSFixMe,
) {
  ...
  while (queue.length > 0) {
    ...
    if (!visited.has(seek)) {
      visited.add(seek);
      const found =
        prevInactiveTabs?.filter((inactiveTabId: $TSFixMe) =>
          currentLayout[inactiveTabId]?.parents
            .filter((id: $TSFixMe) => id.startsWith('TAB-'))
            .slice(-1)
            .includes(seek),
        ) ?? [];
...
export function setActiveTab(tabId: $TSFixMe, prevTabId: $TSFixMe) {
  return (dispatch: $TSFixMe, getState: $TSFixMe) => {
...
export function setDatasetsStatus(status: $TSFixMe) {
  return {
...
const storeDashboardColorConfig = async (id: $TSFixMe, metadata: $TSFixMe) =>
  SupersetClient.put({
...
export const applyDashboardLabelsColorOnLoad =
  (metadata: $TSFixMe) => async (dispatch: $TSFixMe) => {
    try {
      ...
      if (
        ...
        Object.keys(sharedLabels).length > 0
      ) {
        hasChanged = true;
        dispatch(
...
export const ensureSyncedLabelsColorMap =
  (metadata: $TSFixMe) => (dispatch: $TSFixMe, getState: $TSFixMe) => {
...
export const ensureSyncedSharedLabelsColors =
  (metadata: $TSFixMe, forceFresh = false) =>
...
export const updateDashboardLabelsColor =
  (renderedChartIds: $TSFixMe) => (_: $TSFixMe, getState: $TSFixMe) => {
    try {
      const {
        dashboardInfo: { metadata },
        charts,
