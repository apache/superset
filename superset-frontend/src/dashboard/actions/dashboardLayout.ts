...
function setUnsavedChangesAfterAction(action: $TSFixMe) {
  return (...args: $TSFixMe[]) =>
...
export function updateDashboardTitle(text: $TSFixMe) {
...
export function dashboardTitleChanged(text: $TSFixMe) {
  return {
...
export function resizeComponent({ id, width, height }: $TSFixMe) {
  return (dispatch: $TSFixMe, getState: $TSFixMe) => {
...
const moveComponent = setUnsavedChangesAfterAction((dropResult: $TSFixMe) => ({
  type: MOVE_COMPONENT,
...
export function handleComponentDrop(dropResult: $TSFixMe) {
  return (dispatch: $TSFixMe, getState: $TSFixMe) => {
