...
import { SET_NATIVE_FILTERS_CONFIG_COMPLETE } from './nativeFilters';
...
export const SET_IN_SCOPE_STATUS_OF_CUSTOMIZATIONS =
  'SET_IN_SCOPE_STATUS_OF_CUSTOMIZATIONS';
export interface SetInScopeStatusOfCustomizations {
  type: typeof SET_IN_SCOPE_STATUS_OF_CUSTOMIZATIONS;
  payload: {
...
export function setInScopeStatusOfCustomizations(
  ...
  return {
    type: SET_IN_SCOPE_STATUS_OF_CUSTOMIZATIONS,
    payload: customizationScopes,
  };
}
