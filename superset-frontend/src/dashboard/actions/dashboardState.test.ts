...
describe('dashboardState actions', () => {
  ...
  beforeEach(() => {
    postStub = sinon
      ...
      // @ts-expect-error TS(2345): Argument of type '"the value you want to return"' ... Remove this comment to see the full error message
      .resolves('the value you want to return');
    // @ts-expect-error TS(2345): Argument of type '{ json: { result: { css: string;... Remove this comment to see the full error message
  ...
  function setup(stateOverrides: $TSFixMe) {
  ...
  describe('saveDashboardRequest', () => {
    ...
    it('should post dashboard data with updated redux state', () => {
      ...
      expect(
        // @ts-expect-error TS(2339): Property 'parents' does not exist on type '{ type:... Remove this comment to see the full error message
    ...
    describe('FeatureFlag.CONFIRM_DASHBOARD_DIFF', () => {
      beforeEach(() => {
        ...
        isFeatureEnabled.mockImplementation(
          (feature: $TSFixMe) => feature === 'CONFIRM_DASHBOARD_DIFF',
        );
      });

      afterEach(() => {
        // @ts-expect-error TS(2339): Property 'mockRestore' does not exist on type '(fe... Remove this comment to see the full error message
