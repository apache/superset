...
function mapStateToProps(
  { sliceEntities, dashboardInfo, dashboardState }: $TSFixMe,
  ownProps: $TSFixMe,
) {
  return {
...
// @ts-expect-error TS(2345): Argument of type 'ForwardRefExoticComponent<Pick<P... Remove this comment to see the full error message
