...
import { ScoreCardProps, ScoreCardStylesProps } from './types';
...
const Styles = styled.div<ScoreCardStylesProps>`
...
export default class ScoreCard extends PureComponent<ScoreCardProps> {
