...
import { CountryMapChartPlugin as CountryMapV2ChartPlugin } from '@superset-ui/plugin-chart-country-map';
  ...
  constructor() {
    ...
    super({
      ...
      plugins: [
        ...
        new CountryMapV2ChartPlugin().configure({ key: VizType.CountryMapV2 }),
