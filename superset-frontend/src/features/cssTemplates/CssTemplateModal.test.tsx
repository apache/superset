...
import { Modal, CssEditor } from '@superset-ui/core/components';
...
async function mountAndWait(props = mockedProps) {
  const mounted = mount(
    <Provider store={store}>
      // @ts-expect-error TS(2783): 'show' is specified more than once, so this
      usage ... Remove this comment to see the full error message
