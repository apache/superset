...
describe('chart actions', () => {
  ...
  let getExploreUrlStub: $TSFixMe;
  let getChartDataUriStub: $TSFixMe;
  let waitForAsyncDataStub: $TSFixMe;
  let fakeMetadata: $TSFixMe;
  ...
  describe('v1 API', () => {
    ...
    it('should handle the bigint without regression', async () => {
      ...
      // @ts-expect-error TS(2339): Property 'value' does not exist on type 'JsonObjec... Remove this comment to see the full error message
  ...
  describe('runAnnotationQuery', () => {
    ...
    it('should dispatch annotationQueryStarted and annotationQuerySuccess on successful query', async () => {
      ...
      // @ts-expect-error TS(2345): Argument of type '() => Promise<{ json: { result: ... Remove this comment to see the full error message
