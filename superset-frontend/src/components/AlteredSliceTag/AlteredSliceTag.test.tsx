...
test('renders the "Altered" label', () => {
  render(
    <AlteredSliceTag
      // @ts-expect-error TS(2322): Type 'Partial<SqlaFormData>' is not assignable to ... Remove this comment to see the full error message
...
test('alterForComparison returns value for non-empty object', () => {
  ...
  // @ts-expect-error TS(2345): Argument of type '{ key: string; }' is not assigna... Remove this comment to see the full error message
  expect(alterForComparison(value)).toEqual(value);
});
...
test('isEqualish considers deeply equal objects equal', () => {
  ...
  // @ts-expect-error TS(2345): Argument of type '{ a: { b: { c: number; }; }; }' ... Remove this comment to see the full error message
  expect(isEqualish(obj1, obj2)).toBe(true);
  // Actually  not equal
  // @ts-expect-error TS(2345): Argument of type '{ a: number; b: number; z: numbe... Remove this comment to see the full error message
