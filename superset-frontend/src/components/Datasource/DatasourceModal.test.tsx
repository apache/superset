...
describe('DatasourceModal', () => {
  ...
  it('disables the save button when the datasource is managed externally', () => {
    ...
    renderAndWait({
      ...mockedProps,
      // @ts-expect-error TS(2322): Type '{ is_managed_externally: true; verbose_map: ... Remove this comment to see the full error message
  ...
  it('calls the onDatasourceSave function when the save button is clicked', async () => {
    ...
    // @ts-expect-error TS(2740): Type 'Mock<any, any, any>' is missing the followin... Remove this comment to see the full error message
