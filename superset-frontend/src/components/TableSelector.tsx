...
const TableSelector: FunctionComponent<TableSelectorProps> = ({
  ...
  function fetchTables(
    ...
    if (actualDbId && dbSchema) {
      ...
      return SupersetClient.get({ endpoint })
        .then(({ json }) => {
          const options = json.options.map((o: Record<string, $anyType>) => ({
            value: o.value,
            schema: o.schema,
            label: o.label,
            title: o.title,
  ...
  function changeSchema(schemaOpt: Record<string, $anyType>, force = false) {
  ...
  function renderTableOption(option: Record<string, $anyType>) {
    return (
