...
describe('store', () => {
  ...
  describe('applyDefaultFormData', () => {
    window.featureFlags = {
      // @ts-expect-error TS(2322): Type '{ SCOPED_FILTER: boolean; }' is not assignab... Remove this comment to see the full error message
      SCOPED_FILTER: false,
    };
    ...
    it('applies default to formData if the key is missing', () => {
      ...
      // @ts-expect-error TS(2339): Property 'row_limit' does not exist on type '{}'.
