...
const Styles = styled.div`
  ...
  .gutter.gutter-vertical {
    // @ts-expect-error TS(2339): Property 'showSplite' does not exist on type '{ th... Remove this comment to see the full error message
      ...
      >
        {chartPanelWidth && chartPanelHeight && (
          <ChartContainer
            ...
            formData={formData}
            // @ts-expect-error TS(2322): Type '{ width: number; height: number; ownState: a... Remove this comment to see the full error message
