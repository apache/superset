...
const EmbedCodeContent = ({ formData, addDangerToast }: $TSFixMe) => {
  ...
  return (
    <div id="embed-code-popover" data-test="embed-code-popover">
      ...
      <Space
        // @ts-expect-error TS(2820): Type '"horizzontal"' is not assignable to type '"h... Remove this comment to see the full error message
