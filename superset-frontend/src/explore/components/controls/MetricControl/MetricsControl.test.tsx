...
function setup(overrides: $TSFixMe) {
      ...
      value={[
        {
          ...
          sqlExpression: 'COUNT(*)',
          label: 'old label',
          // @ts-expect-error TS(2322): Type '{ expressionType: string; sqlExpression: str... Remove this comment to see the full error message
          hasCustomLabel: true,
        },
      ]}
      columns={[
