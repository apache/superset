...
import { CheckboxGroupProps } from 'src/components/Radio';
...
export const COMMON_RANGE_OPTIONS: CheckboxGroupProps<string>['options'] = [
...
export const CALENDAR_RANGE_OPTIONS: CheckboxGroupProps<string>['options'] = [
...
export const CURRENT_RANGE_OPTIONS: CheckboxGroupProps<string>['options'] = [
