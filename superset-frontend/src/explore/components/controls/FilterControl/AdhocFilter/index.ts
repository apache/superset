...
export default class AdhocFilter {
  ...
  datasourceWarning: $TSFixMe;

  expressionType: $TSFixMe;

  filterOptionName: $TSFixMe;
  ...
  sqlExpression: $TSFixMe;

  subject: $TSFixMe;

  constructor(adhocFilter: $TSFixMe) {
  ...
  duplicateWith(nextFields: $TSFixMe) {
