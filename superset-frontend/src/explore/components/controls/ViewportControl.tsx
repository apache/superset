...
export default class ViewportControl extends Component {
  ...
  onChange(ctrl: $TSFixMe, value: $TSFixMe) {
  ...
  renderTextControl(ctrl: $TSFixMe) {
    return (
      <div key={ctrl}>
  ...
  render() {
    return (
      <div>
        ...
        <Popover
          // @ts-expect-error TS(2322): Type '{ children: Element; container: HTMLElement;... Remove this comment to see the full error message
