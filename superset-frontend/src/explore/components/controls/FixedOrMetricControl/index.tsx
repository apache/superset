...
export default class FixedOrMetricControl extends Component {
    ...
    this.props.onChange({
      ...
      value:
        ...
        this.state.type === controlTypes.fixed
          // @ts-expect-error TS(2339): Property 'fixedValue' does not exist on type 'Read... Remove this comment to see the full error message
          ? this.state.fixedValue
          // @ts-expect-error TS(2339): Property 'metricValue' does not exist on type 'Rea... Remove this comment to see the full error message
  ...
  setFixedValue(fixedValue: $TSFixMe) {
    this.setState({ fixedValue }, this.onChange);
  }

  setMetric(metricValue: $TSFixMe) {
                ...
                <div className="well">
                  ...
                  >
                    <MetricsControl
                      ...
                      multi={false}
                      // @ts-expect-error TS(2322): Type '{ name: string; columns: any; savedMetrics: ... Remove this comment to see the full error message
                      onFocus={() => {
                        this.setType(controlTypes.metric);
                      }}
