...
const saveButtonStyles = (theme: $TSFixMe) => css`
...
const additionalItemsStyles = (theme: $TSFixMe) => css`
  display: flex;
  align-items: center;
...
export const ExploreChartHeader = ({
  ...
  const updateCategoricalNamespace = async () => {
    ...
    const dashboard =
      dashboardId &&
      dashboards &&
      dashboards.find((d: $TSFixMe) => d.id === dashboardId);
      ...
      <PageHeaderWithActions
        ...
        titlePanelAdditionalItems={
          <div css={additionalItemsStyles}>
            {sliceFormData ? (
              <AlteredSliceTag
                // @ts-expect-error TS(2322): Type '{ className: string; origFormData: any; curr... Remove this comment to see the full error message
                className="altered"
                origFormData={{
                  ...sliceFormData,
