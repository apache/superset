...
function handleDeprecatedControls(formData: $TSFixMe) {
...
export function getControlsState(state: $TSFixMe, inputFormData: $TSFixMe) {
  /*
...
export function applyDefaultFormData(inputFormData: $TSFixMe) {
  ...
  // @ts-expect-error TS(2345): Argument of type 'Record<string, ControlState<any,... Remove this comment to see the full error message
...
const defaultState = {
  ...
  // @ts-expect-error TS(2345): Argument of type '{ metrics: { type: string; multi... Remove this comment to see the full error message
