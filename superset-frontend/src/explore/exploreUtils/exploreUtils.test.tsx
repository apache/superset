...
describe('exploreUtils', () => {
  ...
  function compareURI(uri1: $TSFixMe, uri2: $TSFixMe) {
  ...
  describe('getQuerySettings', () => {
    beforeAll(() => {
      getChartMetadataRegistry()
        // @ts-expect-error TS(2345): Argument of type '{ useLegacyApi: true; }' is not ... Remove this comment to see the full error message
        .registerValue('my_legacy_viz', { useLegacyApi: true })
        // @ts-expect-error TS(2345): Argument of type '{ useLegacyApi: false; }' is not... Remove this comment to see the full error message
