...
const iconExprs = {
  ...
  'supermarkets': [
    'case',
    ...gen_proposed([19145, 19153], 'tenant_id', 'woolworths'),
    ...gen_proposed([3898, 44728], 'tenant_id', 'coles'),
    ...gen_proposed(341, 'tenant_id', 'aldi'),
    ...gen_proposed(8291, 'tenant_id', 'iga'),
    ...gen_proposed(6267, 'tenant_id', 'foodWorks'),
    ...gen_proposed(4149, 'tenant_id', 'costco'),
    ...gen_proposed(39173, 'tenant_id', 'drakes'),
    ...gen_proposed(15874, 'tenant_id', 'spar'),
    ...gen_proposed(8294, 'tenant_id', 'igaExpress'),
    ...gen_proposed(18239, 'tenant_id', 'unknownSmkt'),
    PROPOSED_CHECK,
    'otherSmktP',
    'otherSmkt'
  ],
  ...
  'liquor': [
    'case',
    ...gen_proposed(10154, 'tenant_id', 'liquorLand'),
    ...gen_proposed(2494, 'tenant_id', 'bws'),
    ...gen_proposed(93808, 'tenant_id', 'igaLiquor'),
    ...gen_proposed(39252, 'tenant_id', 'aldiLiquor'),
    ...gen_proposed(18514, 'tenant_id', 'vintageCellars'),
    ...gen_proposed(6058, 'tenant_id', 'firstChoiceLiquor'),
    ...gen_proposed(4492, 'tenant_id', 'danMurphys'),
    PROPOSED_CHECK,
    'otherLiquorP',
