...
// Extra import to update URL params
...
export function refreshChart(chartKey, force, dashboardId) {
  return (dispatch, getState) => {
    ...
    // Grab current url params and update in chart form data
    const newFormData = {...chart.latestQueryFormData, url_params: extractUrlParams('regular')};
    dispatch(
      postChartFormData(
        //chart.latestQueryFormData,
        newFormData, // refresh chart with latest form data
        force,
        timeout,
        chart.id,
        dashboardId,
