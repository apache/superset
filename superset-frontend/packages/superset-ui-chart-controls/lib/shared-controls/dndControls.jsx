...
export const dndGroupByControl = {
    ...
    label: t('Group by'),
    default: [],
    description: t('One or many columns to group by. High cardinality groupings should include a series limit ' +
...
export const dnd_granularity_sqla = {
    ...
    description: t('The time column for the visualization. Note that you ' +
        ...
        'expression'),
    canDelete: false,
    ghostButtonText: t(isFeatureEnabled(FeatureFlag.ENABLE_DND_WITH_CLICK_UX)
...
//# sourceMappingURL=dndControls.jsx.map