 ...
 */
export default function ColumnConfigControl({ queryResponse, appliedColumnNames = [], value, onChange, configFormLayout = DEFAULT_CONFIG_FORM_LAYOUT, emitFilter, ...props }) {
    if (emitFilter) {
    ...
    return (<>
      ...
      <div css={{
        ...
        {cols.map(col => (<ColumnConfigItem key={col} column={getColumnInfo(col)} onChange={config => setColumnConfig(col, config)} configFormLayout={configFormLayout}/>))}
        {needShowMoreButton && (<div role="button" tabIndex={-1} css={{
...
//# sourceMappingURL=ColumnConfigControl.jsx.map