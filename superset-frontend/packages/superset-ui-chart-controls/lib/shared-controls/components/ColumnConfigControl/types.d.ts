...
export declare type ColumnConfigFormItem = SharedColumnConfigProp | {
    name: SharedColumnConfigProp;
    override: Partial<ControlFormItemSpec>;
} | {
    name: string;
    config: ControlFormItemSpec;
};
export declare type ColumnConfigFormLayout = Record<GenericDataType, ColumnConfigFormItem[][]>;
