...
export default function ColumnConfigPopover({ column, configFormLayout, onChange, }) {
    return (<ControlForm onChange={onChange} value={column.config}>
      {configFormLayout[column.type === undefined ? GenericDataType.STRING : column.type].map((row, i) => (<ControlFormRow key={i}>
          {row.map(meta => {
...
//# sourceMappingURL=ColumnConfigPopover.jsx.map