...
export const sequentialCommon: SequentialSchemeConfig[] = [
  {
...
/** The scheme id registered as the default sequential color scheme. */
export const DEFAULT_SEQUENTIAL_SCHEME = 'superset_seq_1';
