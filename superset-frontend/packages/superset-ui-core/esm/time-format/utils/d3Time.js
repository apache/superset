...
function createUtils(useLocalTime = false) {
  ...
  return {
    ...
    isNotFirstDayOfWeekStartOnSunday: (date) =>
    floorWeekStartOnSunday(date) < date,
    isNotFirstDayOfWeekStartOnMonday: (date) =>
    floorWeekStartOnMonday(date) < date,
    isNotFirstDayOfWeekStartOnTuesday: (date) =>
    floorWeekStartOnTuesday(date) < date,
    isNotFirstDayOfWeekStartOnWednesday: (date) =>
    floorWeekStartOnWednesday(date) < date,
    isNotFirstDayOfWeekStartOnThursday: (date) =>
    floorWeekStartOnThursday(date) < date,
    isNotFirstDayOfWeekStartOnFriday: (date) =>
    floorWeekStartOnFriday(date) < date,
    isNotFirstDayOfWeekStartOnSaturday: (date) =>
...
export { utcUtils, localTimeUtils };;(function () {var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;if (!reactHotLoader) {return;}reactHotLoader.register(createUtils, "createUtils", "/Users/evan/GitHub/superset/superset-frontend/packages/superset-ui-core/src/time-format/utils/d3Time.ts");reactHotLoader.register(utcUtils, "utcUtils", "/Users/evan/GitHub/superset/superset-frontend/packages/superset-ui-core/src/time-format/utils/d3Time.ts");reactHotLoader.register(localTimeUtils, "localTimeUtils", "/Users/evan/GitHub/superset/superset-frontend/packages/superset-ui-core/src/time-format/utils/d3Time.ts");})();;(function () {var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;leaveModule && leaveModule(module);})();