...
describe('CategoricalColorScale', () => {
  ...
  describe('.getColor(value, sliceId)', () => {
    ...
    it('reassigns colliding colors when no sliceId is provided', () => {
      window.featureFlags = {
    ...
    it('reassigns non-forced labels when a dashboard-synced label would duplicate their color', () => {
      window.featureFlags = {
        [FeatureFlag.AvoidColorsCollision]: true,
      };
  ...
  describe('dashboard shared-dimension color collision', () => {
    ...
    it('reproduces the bug without the fix: Classic Cars and Trains would both be red', () => {
      window.featureFlags = {
        [FeatureFlag.AvoidColorsCollision]: false,
      };
    ...
    it('fix: Classic Cars is reassigned when Trains locks red from the dashboard', () => {
      const PALETTE = ['red', 'blue', 'green'];
    ...
    it('fix: no series in Chart B share a color when palette has enough colors', () => {
      const PALETTE = ['red', 'blue', 'green'];
    ...
    it('fix: increments analogous color range for dashboard collisions when UseAnalogousColors is enabled', () => {
      window.featureFlags = {
        [FeatureFlag.AvoidColorsCollision]: true,
        [FeatureFlag.UseAnalogousColors]: true,
      };
    ...
    it('fix: forced colors (user-set in dashboard JSON) are never reassigned', () => {
      const PALETTE = ['red', 'blue', 'green'];
