...
import { ChartProps, supersetTheme, EmotionThemeProvider } from '@superset-ui/core';
...
const renderWithTheme = (component: ReactElement) =>
  render(<EmotionThemeProvider theme={supersetTheme}>{component}</EmotionThemeProvider>);
