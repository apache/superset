...
describe('MatrixifyGridGenerator', () => {
  ...
  describe('generateMatrixifyGrid', () => {
    ...
    it('should generate a 2x2 grid for metrics mode', () => {
    ...
    it('should generate grid for dimensions mode', () => {
    ...
    it('should generate grid for mixed mode (metrics rows, dimensions columns)', () => {
    ...
    it('should preserve existing adhoc filters', () => {
