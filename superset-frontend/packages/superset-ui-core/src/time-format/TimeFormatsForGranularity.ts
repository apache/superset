...
const TimeFormatsForGranularity: Record<TimeGranularity, string> = {
  ...
  [TimeGranularity.THREE_HOURS]: '%Y-%m-%d %H:00',
  [TimeGranularity.SIX_HOURS]: '%Y-%m-%d %H:00',
  [TimeGranularity.TWELVE_HOURS_6AM]: '%Y-%m-%d %H:00',
  [TimeGranularity.DAY]: DATABASE_DATE,
  [TimeGranularity.DAY_6AM]: DATABASE_DATE,
