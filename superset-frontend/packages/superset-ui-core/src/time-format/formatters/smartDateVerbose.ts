...
export function createSmartDateVerboseFormatter(
  ...
  return createMultiFormatter({
    ...
    formats: formats?.[SMART_DATE_VERBOSE_ID]
      ? formats?.[SMART_DATE_VERBOSE_ID]
      : DEFAULT_SMART_DATE_FORMAT[SMART_DATE_VERBOSE_ID],
    locale,
  });
}
