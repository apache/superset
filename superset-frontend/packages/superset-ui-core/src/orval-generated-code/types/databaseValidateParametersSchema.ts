 ...
 */
import type { DatabaseValidateParametersSchemaCatalog } from './databaseValidateParametersSchemaCatalog';
import type { DatabaseValidateParametersSchemaConfigurationMethod } from './databaseValidateParametersSchemaConfigurationMethod';
import type { DatabaseValidateParametersSchemaParameters } from './databaseValidateParametersSchemaParameters';

export interface DatabaseValidateParametersSchema {
  /** Gsheets specific column for managing label to sheet urls */
  catalog?: DatabaseValidateParametersSchemaCatalog;
  ...
  parameters?: DatabaseValidateParametersSchemaParameters;
  /**
