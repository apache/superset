 ...
 */
import type { EngineInformation } from './engineInformation';
import type { DatabaseConnectionSchemaParameters } from './databaseConnectionSchemaParameters';
import type { DatabaseConnectionSchemaParametersSchema } from './databaseConnectionSchemaParametersSchema';
import type { DatabaseConnectionSchemaSshTunnel } from './databaseConnectionSchemaSshTunnel';
...
export interface DatabaseConnectionSchema {
  ...
  parameters?: DatabaseConnectionSchemaParameters;
  /** JSONSchema for configuring the database by parameters instead of SQLAlchemy URI */
  parameters_schema?: DatabaseConnectionSchemaParametersSchema;
  /**
  ...
  /** @nullable */
  ssh_tunnel?: DatabaseConnectionSchemaSshTunnel;
  uuid?: string;
}
