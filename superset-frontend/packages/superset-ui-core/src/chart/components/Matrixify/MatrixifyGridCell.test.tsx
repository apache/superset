...
describe('MatrixifyGridCell', () => {
  ...
  it('should render SuperChart with correct props', () => {
    renderWithTheme(<MatrixifyGridCell {...defaultProps} />);
  ...
  it('should calculate chart height correctly with title', () => {
    renderWithTheme(<MatrixifyGridCell {...defaultProps} />);
  ...
  it('should calculate chart height correctly without title', () => {
    const cellWithoutTitle = {
      ...mockCell,
      title: undefined,
    };
  ...
  it('should handle different viz types', () => {
  ...
  it('should pass through additional formData properties', () => {
  ...
  it('should handle small cell dimensions', () => {
