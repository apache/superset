...
describe('MatrixifyGridRenderer', () => {
  ...
  it('should render the grid with all cells', () => {
  ...
  it('should render column headers when enabled', () => {
    renderWithTheme(<MatrixifyGridRenderer {...defaultProps} />);
  ...
  it('should render row labels when enabled', () => {
    renderWithTheme(<MatrixifyGridRenderer {...defaultProps} />);
  ...
  it('should hide column headers when disabled', () => {
  ...
  it('should hide row labels when disabled', () => {
  ...
  it('should calculate column widths based on grid layout', () => {
    renderWithTheme(<MatrixifyGridRenderer {...defaultProps} />);
  ...
  it('should apply overflow styling to container', () => {
    const { container } = renderWithTheme(
      <MatrixifyGridRenderer {...defaultProps} />,
    );
  ...
  it('should call generateMatrixifyGrid with correct formData', () => {
    renderWithTheme(<MatrixifyGridRenderer {...defaultProps} />);
  ...
  it('should handle dimension mode grid', () => {
