...
describe('LabeledErrorBoundInput', () => {
  it('renders a LabeledErrorBoundInput normally, without an error', () => {
    // @ts-expect-error TS(2322): Type '{ id: number; label: string; name: string; v... Remove this comment to see the full error message
  ...
  it('becomes a password input if visibilityToggle prop is passed in', async () => {
    // @ts-expect-error TS(2339): Property 'visibilityToggle' does not exist on type... Remove this comment to see the full error message
