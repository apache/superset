...
class WithLegend extends PureComponent {
    ...
    render() {
        ...
        return (<div className={`with-legend ${className}`} style={style}>
        {renderLegend && (<div className="legend-container" style={legendStyle}>
            {renderLegend({
...
//# sourceMappingURL=WithLegend.jsx.map