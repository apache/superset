 ...
 */
export declare type Locale = 'de' | 'en' | 'es' | 'fr' | 'it' | 'ja' | 'ko' | 'pt' | 'pt_BR' | 'ru' | 'zh';
/**
 * Language pack provided to `jed`.
 */
export declare type LanguagePack = JedOptions & {
    locale_data: {
        superset: DomainData & {
            '': {
                domain: 'superset';
 ...
 */
export declare type LocaleData = Partial<Record<Locale, Translations>>;
