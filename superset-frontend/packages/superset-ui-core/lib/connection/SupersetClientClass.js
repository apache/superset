...
export default class SupersetClientClass {
    ...
    mode;
    timeout;
    constructor({ baseUrl = DEFAULT_BASE_URL, host, protocol, headers = {}, fetchRetryOptions = {}, mode = 'same-origin', timeout, credentials = undefined, csrfToken = undefined, } = {}) {
    ...
    async request({ credentials, mode, endpoint, host, url, headers, timeout, fetchRetryOptions, ...rest }) {
...
//# sourceMappingURL=SupersetClientClass.js.map