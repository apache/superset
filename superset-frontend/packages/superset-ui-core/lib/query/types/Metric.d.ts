...
export declare type AdhocMetric = AdhocMetricSimple | AdhocMetricSQL;
/**
 * Select a predefined metric by its `metric_name`.
 */
export declare type SavedMetric = string;
/**
...
export declare function isAdhocMetricSimple(metric: AdhocMetric): metric is AdhocMetricSimple;
