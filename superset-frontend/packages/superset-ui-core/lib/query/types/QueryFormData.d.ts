 ...
 */
export declare type QueryFormColumn = PhysicalColumn | AdhocColumn;
/**
...
export declare type ExtraFormDataAppend = {
...
export declare type ExtraFormDataOverrideExtras = Pick<QueryObjectExtras, 'druid_time_origin' | 'relative_start' | 'relative_end' | 'time_grain_sqla' | 'time_range_endpoints'>;
/** These parameters override those already present in the form data/query object */
export declare type ExtraFormDataOverrideRegular = Partial<Pick<SqlaFormData, 'granularity_sqla'>> & Partial<Pick<DruidFormData, 'granularity'>> & Partial<Pick<BaseFormData, 'time_range'>> & Partial<Pick<QueryObject, 'time_column' | 'time_grain'>>;
/** These parameters override those already present in the form data/query object */
export declare type ExtraFormDataOverride = ExtraFormDataOverrideRegular & ExtraFormDataOverrideExtras;
export declare type ExtraFormData = ExtraFormDataAppend & ExtraFormDataOverride;
...
export declare function isSavedMetric(metric: QueryFormMetric): metric is SavedMetric;
