...
export default function normalizeOrderBy(queryObject) {
    ...
    if (queryObject.timeseries_limit_metric !== undefined &&
    ...
    if (queryObject.legacy_order_by !== undefined &&
...
//# sourceMappingURL=normalizeOrderBy.js.map