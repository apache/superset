...
- [21163](https://github.com/apache/superset/pull/21163): When `GENERIC_CHART_AXES` feature flags to `True`, the Time Grain control will move below the X-Axis control.
