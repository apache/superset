...
- [26328](https://github.com/apache/superset/issues/26328): Removes the deprecated Filter Box code. To be able to upgrade, you need to first migrate your deprecated filter boxes using the `superset native-filters upgrade` command available in previous versions of Superset.
