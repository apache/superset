...
- [23853](https://github.com/apache/superset/pull/23853): Migrated endpoint `/superset/warm_up_cache` to `/api/v1/charts/warm_up_cache/`. Corresponding permissions are `can warm_up_cache on Superset` to `can warm_up_cache on Chart`. Make sure you add/replace the necessary permissions on any custom roles you may have.
