...
## Next
- [xxxxx](https://github.com/apache/superset/pull/xxxxx): Fixes the spelling of the `USE-ANALAGOUS-COLORS` feature flag. Please update any scripts/configuration item to use the new/corrected `USE-ANALOGOUS-COLORS` flag spelling.
