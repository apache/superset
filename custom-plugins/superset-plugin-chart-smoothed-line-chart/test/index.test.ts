 ...
 * under the License.
 */
import { SupersetPluginChartSmoothedLineChart } from '../src';
 ...
 */
describe('superset-plugin-chart-smoothed-line-chart', () => {
  it('exists', () => {
    expect(SupersetPluginChartSmoothedLineChart).toBeDefined();
  });
});
