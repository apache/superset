...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@a88e03874f12f37cff10f143e7b5f8187eb659fb", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@a88e03874f12f37cff10f143e7b5f8187eb659fb"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@a88e03874f12f37cff10f143e7b5f8187eb659fb", "tableschema", "thrift>=0.14.1, <1.0.0"],
