...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@954bc68159dfa31e6b2698cbd3eed5b8c050041a", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@954bc68159dfa31e6b2698cbd3eed5b8c050041a"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@954bc68159dfa31e6b2698cbd3eed5b8c050041a", "tableschema", "thrift>=0.14.1, <1.0.0"],
