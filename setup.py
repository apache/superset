...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@a07195b4d9256c6883c649d28ab947af1254c90f", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@a07195b4d9256c6883c649d28ab947af1254c90f"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@a07195b4d9256c6883c649d28ab947af1254c90f", "tableschema", "thrift>=0.14.1, <1.0.0"],
