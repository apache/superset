...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@dcefc2b8dbb31923dd205f846be52ad57b33abca", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@dcefc2b8dbb31923dd205f846be52ad57b33abca"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@dcefc2b8dbb31923dd205f846be52ad57b33abca", "tableschema", "thrift>=0.14.1, <1.0.0"],
