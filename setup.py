...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@2c9a6feabc25044ac454895db842d6c872ec50b8", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "spark": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@2c9a6feabc25044ac454895db842d6c872ec50b8", "tableschema", "thrift>=0.14.1, <1.0.0"],
