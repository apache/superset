...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@30cb7b150faba7058b4aa451e2bc46678c861716", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@30cb7b150faba7058b4aa451e2bc46678c861716"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@30cb7b150faba7058b4aa451e2bc46678c861716", "tableschema", "thrift>=0.14.1, <1.0.0"],
