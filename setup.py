...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@b3c123195b6d2586e1e609eefecafe036324eb46", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@b3c123195b6d2586e1e609eefecafe036324eb46"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@b3c123195b6d2586e1e609eefecafe036324eb46", "tableschema", "thrift>=0.14.1, <1.0.0"],
