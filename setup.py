...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@a4c30f21f7e0cfe830b3a04ade7edf5cd103c678", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@a4c30f21f7e0cfe830b3a04ade7edf5cd103c678"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@a4c30f21f7e0cfe830b3a04ade7edf5cd103c678", "tableschema", "thrift>=0.14.1, <1.0.0"],
