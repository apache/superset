...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@5e20ded4c9bdb49069e4893e4bf4bccb700e58df", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@5e20ded4c9bdb49069e4893e4bf4bccb700e58df"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@5e20ded4c9bdb49069e4893e4bf4bccb700e58df", "tableschema", "thrift>=0.14.1, <1.0.0"],
