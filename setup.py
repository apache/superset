...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure_sasl]>=0.7.1.dev0", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]>=0.7.1.dev0"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure_sasl]>=0.7.1.dev0", "tableschema", "thrift>=0.14.1, <1.0.0"],
