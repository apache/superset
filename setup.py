...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure]@git+https://github.com/dropbox/PyHive.git@a54db4fe5bd84ac2890820abe510e665661991a1", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@a54db4fe5bd84ac2890820abe510e665661991a1"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure]@git+https://github.com/dropbox/PyHive.git@a54db4fe5bd84ac2890820abe510e665661991a1", "tableschema", "thrift>=0.14.1, <1.0.0"],
