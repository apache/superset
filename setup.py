...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@1b359e9589f069e47af7f1828fff7c48982c8d05", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@1b359e9589f069e47af7f1828fff7c48982c8d05"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@1b359e9589f069e47af7f1828fff7c48982c8d05", "tableschema", "thrift>=0.14.1, <1.0.0"],
