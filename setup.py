...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure]@git+https://github.com/dropbox/PyHive.git@033707f32618137e429aaa4eea1407544144f5e5", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@033707f32618137e429aaa4eea1407544144f5e5"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure]@git+https://github.com/dropbox/PyHive.git@033707f32618137e429aaa4eea1407544144f5e5", "tableschema", "thrift>=0.14.1, <1.0.0"],
