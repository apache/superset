...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@47dc05f30f2f2dca5bc58426fd1c7f1859c881e1", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@47dc05f30f2f2dca5bc58426fd1c7f1859c881e1"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@47dc05f30f2f2dca5bc58426fd1c7f1859c881e1", "tableschema", "thrift>=0.14.1, <1.0.0"],
