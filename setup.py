...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@906d381cb64c7ce2440b6a40f2446b05c3d99fd1", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@906d381cb64c7ce2440b6a40f2446b05c3d99fd1"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@906d381cb64c7ce2440b6a40f2446b05c3d99fd1", "tableschema", "thrift>=0.14.1, <1.0.0"],
