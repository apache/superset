...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@033707f32618137e429aaa4eea1407544144f5e5", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "spark": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@033707f32618137e429aaa4eea1407544144f5e5", "tableschema", "thrift>=0.14.1, <1.0.0"],
