...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@78eb16bb4e8ad42188011f14c1ff2554ad370ef9", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@78eb16bb4e8ad42188011f14c1ff2554ad370ef9"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@78eb16bb4e8ad42188011f14c1ff2554ad370ef9", "tableschema", "thrift>=0.14.1, <1.0.0"],
