...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure]@git+https://github.com/dropbox/PyHive.git@dd62269e4f10ae0bd424a71a0f2c5ce27f53365e", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@dd62269e4f10ae0bd424a71a0f2c5ce27f53365e"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure]@git+https://github.com/dropbox/PyHive.git@dd62269e4f10ae0bd424a71a0f2c5ce27f53365e", "tableschema", "thrift>=0.14.1, <1.0.0"],
