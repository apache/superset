...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@2cf0d8321f30fb035e14e7f88ef03096b40b93c4", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@2cf0d8321f30fb035e14e7f88ef03096b40b93c4"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@2cf0d8321f30fb035e14e7f88ef03096b40b93c4", "tableschema", "thrift>=0.14.1, <1.0.0"],
