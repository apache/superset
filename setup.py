...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@36e6364a5e86d5df719def8239813a6df576e008", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@36e6364a5e86d5df719def8239813a6df576e008"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive_pure_sasl]@git+https://github.com/dropbox/PyHive.git@36e6364a5e86d5df719def8239813a6df576e008", "tableschema", "thrift>=0.14.1, <1.0.0"],
