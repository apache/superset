...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@20cd74fcaf3d919825c5dc6192a8e968b9723e6b", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@20cd74fcaf3d919825c5dc6192a8e968b9723e6b"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@20cd74fcaf3d919825c5dc6192a8e968b9723e6b", "tableschema", "thrift>=0.14.1, <1.0.0"],
