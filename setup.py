...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive_pure]@git+https://github.com/dropbox/PyHive.git@93af30db22f111ca6cb88127652b497ca54ba55e", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "spark": ["pyhive[hive_pure]@git+https://github.com/dropbox/PyHive.git@93af30db22f111ca6cb88127652b497ca54ba55e", "tableschema", "thrift>=0.14.1, <1.0.0"],
