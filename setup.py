...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@7563946170ad5e4310620239967bd5a02bc0e821", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@7563946170ad5e4310620239967bd5a02bc0e821"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@7563946170ad5e4310620239967bd5a02bc0e821", "tableschema", "thrift>=0.14.1, <1.0.0"],
