...
setup(
    ...
    extras_require={
        ...
        "hive": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@ff984798fac577f286556fcd81c87556c69ff506", "tableschema", "thrift>=0.14.1, <1.0.0"],
        ...
        "presto": ["pyhive[presto]@git+https://github.com/dropbox/PyHive.git@ff984798fac577f286556fcd81c87556c69ff506"],
        "trino": ["trino>=0.324.0"],
        ...
        "spark": ["pyhive[hive]@git+https://github.com/dropbox/PyHive.git@ff984798fac577f286556fcd81c87556c69ff506", "tableschema", "thrift>=0.14.1, <1.0.0"],
