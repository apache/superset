...
# under the License.
"""Integration coverage for the compliance force-purge (sc-111185, US3)."""
...
class TestForcePurge(DeletionRetentionTestBase):
    def test_force_purge_live_entity(self) -> None:
        """SC-PURGE-004: force-purge removes a *live* entity (never
    ...
    def test_force_purge_soft_deleted_entity_and_history(self) -> None:
        """SC-PURGE-004: force-purge a soft-deleted entity removes it and its
    ...
    def test_force_purge_idempotent(self) -> None:
        """SC-PURGE-004: re-running force-purge on a gone UUID is a no-op."""
    ...
    def test_force_purge_dataset_leaves_chart_dangling(self) -> None:
        """SC-PURGE-008 / C15: force-purging a dataset referenced by a live
