...
class TestDatabaseModel(SupersetTestCase):
    ...
    def test_where_operators(self):
        filters: Tuple[FilterTestCase, ...] = (
            ...
            FilterTestCase(
                "ds", FilterOperator.DATETIME_BETWEEN, "2020 : 2021", "2020-01-01"
            ),
        )
...
def test__datetime_between_operator_in_adhoc_filter(app_context, physical_dataset):
    result = physical_dataset.query(
        {
            "columns": ["col1", "col2"],
            "filter": [
                {
                    ...
                    "op": FilterOperator.DATETIME_BETWEEN.value,
                },
                {
                    "col": "col6",
