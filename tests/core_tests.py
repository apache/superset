...
class CoreTests(SupersetTestCase):
    ...
    @mock.patch("superset.views.core_helpers.results_backend_use_msgpack", False)
    @mock.patch("superset.views.core_helpers.results_backend")
    @mock.patch("superset.views.core_helpers.db")
