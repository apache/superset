...
| ('SUM(num)', 'boy')      |                nan |
| ('SUM(num)', 'girl')     |             118065 |
| ('SUM(num)', 'Subvalue (Sum)') |             118065 |
| ('MAX(num)', 'boy')      |                nan |
| ('MAX(num)', 'girl')     |               2588 |
| ('MAX(num)', 'Subvalue (Sum)') |               2588 |
| ('{_("Total")} (Sum)', '')      |             120653 |
    """.strip()
    )
...
| ('girl', 'Sophia', 'MAX(num)') |      2588 |      1187 |
    ...
    assert (
        pivoted.to_markdown()
        == """
|                     |   ('boy', 'Edward') |   ('boy', 'Tony') |   ('boy', 'Subvalue (Sum)') |   ('girl', 'Amy') |   ('girl', 'Cindy') |   ('girl', 'Dawn') |   ('girl', 'Sophia') |   ('girl', 'Subvalue (Sum)') |   ('Total (Sum)', '') |
|:--------------------|--------------------:|------------------:|----------------------:|------------------:|--------------------:|-------------------:|---------------------:|-----------------------:|----------------------:|
| ('CA', 'SUM(num)')  |               31290 |              3765 |                 35055 |             45426 |               14149 |              11403 |                18859 |                  89837 |                124892 |
| ('CA', 'MAX(num)')  |                1280 |               598 |                  1878 |              2227 |                 842 |               1157 |                 2588 |                   6814 |                  8692 |
| ('CA', 'Subvalue (Sum)')  |               32570 |              4363 |                 36933 |             47653 |               14991 |              12560 |                21447 |                  96651 |                133584 |
| ('FL', 'SUM(num)')  |                9395 |              2673 |                 12068 |             14740 |                1218 |               5089 |                 7181 |                  28228 |                 40296 |
| ('FL', 'MAX(num)')  |                 389 |               247 |                   636 |               854 |                 217 |                461 |                 1187 |                   2719 |                  3355 |
| ('FL', 'Subvalue (Sum)')  |                9784 |              2920 |                 12704 |             15594 |                1435 |               5550 |                 8368 |                  30947 |                 43651 |
...
| ('girl', 'Sophia') |               26040 |                3775 |
 """.strip()
    ...
    assert (
        pivoted.to_markdown()
        == """
|                      |   ('SUM(num)', nan) |   ('SUM(num)', 'Subvalue (Sum)') |   ('MAX(num)', nan) |   ('MAX(num)', 'Subvalue (Sum)') |   ('Total (Sum)', '') |
|:---------------------|--------------------:|---------------------------:|--------------------:|---------------------------:|----------------------:|
| ('boy', 'Edward')    |               40685 |                      40685 |                1669 |                       1669 |                 42354 |
| ('boy', 'Tony')      |                6438 |                       6438 |                 845 |                        845 |                  7283 |
| ('boy', 'Subvalue (Sum)')  |               47123 |                      47123 |                2514 |                       2514 |                 49637 |
...
| ('girl', 'Subvalue (Sum)') |              118065 |                     118065 |                9533 |                       9533 |                127598 |
...
| (nan, 'Subvalue (Sum)')   |               42354 |              7283 |                 49637 |             63247 |               16426 |              18110 |                29815 |                 127598 |                177235 |
| ('Total (Sum)', '') |               42354 |              7283 |                 49637 |             63247 |               16426 |              18110 |                29815 |                 127598 |                177235 |
    """.strip()  # noqa: E501
    )
