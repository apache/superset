...
@patch("superset.mcp_service.flask_singleton.app")
def test_init_fastmcp_server_with_default_app_name(mock_flask_app):
...
@patch("superset.mcp_service.flask_singleton.app")
def test_init_fastmcp_server_with_custom_app_name(mock_flask_app):
...
@patch("superset.mcp_service.flask_singleton.app")
def test_init_fastmcp_server_derives_server_name_from_app_name(mock_flask_app):
