...
class QueryCacheManager:
    ...
    def __init__(
        ...
        applied_jinja_filters: Optional[List[str]] = None,
        ...
        self.applied_jinja_filters = applied_jinja_filters or []
        self.status = status
    ...
    def set_query_result(
        ...
        try:
            ...
            self.applied_jinja_filters = query_result.applied_jinja_filters
            ...
            value = {
                "df": self.df,
                "query": self.query,
                "applied_jinja_filters": self.applied_jinja_filters,
    ...
    def get(
        ...
        if cache_value:
            ...
            try:
                ...
                query_cache.applied_jinja_filters = cache_value.get(
