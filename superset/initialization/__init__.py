...
class SupersetAppInitializer:  # pylint: disable=too-many-public-methods
    ...
    def init_views(self) -> None:
        ...
        appbuilder.add_link(
            "Home",
            label=__("Home"),
            href=f"{appbuilder.app.config['APPLICATION_ROOT']}/superset/welcome/",
        ...
        appbuilder.add_link(
            "Datasets",
            label=__("Datasets"),
            href=f"{appbuilder.app.config['APPLICATION_ROOT']}/tablemodelview/list/",
            icon="fa-table",
            category="",
            category_icon="",
        )
        ...
        # Add links
        #
        prefix = appbuilder.app.config["APPLICATION_ROOT"]
        appbuilder.add_link(
            "Import Dashboards",
            label=__("Import Dashboards"),
            href=f"{prefix}/superset/import_dashboards/",
        ...
        appbuilder.add_link(
            ...
            href=f"{prefix}/savedqueryview/list/",
            icon="fa-save",
            category="SQL Lab",
            category_label=__("SQL"),
        )
        ...
        appbuilder.add_view(
            ...
            href=f"{prefix}/annotationlayer/list/",
            icon="fa-comment",
            category_icon="",
            category="Manage",
            category_label=__("Manage"),
        ...
        appbuilder.add_view(
            RowLevelSecurityView,
            "Row Level Security",
            href=f"{prefix}/rowlevelsecurity/list/",
