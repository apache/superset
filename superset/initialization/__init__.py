...
class SupersetAppInitializer:  # pylint: disable=too-many-public-methods
    ...
    def init_views(self) -> None:
        ...
        appbuilder.add_view(
            DatabaseView,
            "Databases",
            label=__("Conexiones a base de datos"),
            icon="fa-database",
            category="Data",
        ...
        appbuilder.add_link(
            "Query Search",
            label=__("Historial de consultas"),
            href="/sqllab/history/",
            icon="fa-search",
            category_icon="fa-flask",
            category="SQL Lab",
        ...
        appbuilder.add_view(
            ...
            label=__("Seguridad a nivel de fila"),
            category="Security",
            category_label=__("Security"),
            icon="fa-lock",
        )
