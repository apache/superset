...
def import_dashboard(
    ...
    for slc in slices:
        ...
        if (
            ...
            and slc.id in i_params_dict["timed_refresh_immune_slices"]
        ):
            new_timed_refresh_immune_slices.append(new_slc_id)
        if (
...
# CHECK - function movement - also called import dashboard function above which wasn't there preiviosuly
def import_dashboards(
    ...
    for dashboard in data["dashboards"]:
        dashboard_ids.append(import_dashboard(dashboard, import_time=import_time))
    session.commit()
