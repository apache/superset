...
class DashboardRestApi(
    ...
    def get(
        ...
        if "charts" in result:
            ...
            # datasets and charts endpoints, which likewise return only the
            # members the caller can access.
            result["charts"] = [
                slc.chart
    ...
    def get_datasets(self, id_or_slug: str) -> Response:
        ...
        try:
            ...
            # Return only the datasets the caller can access on their own.
            result = [
                self.dashboard_dataset_schema.dump(payload)
    ...
    def get_charts(self, id_or_slug: str) -> Response:
        ...
        try:
            ...
            # Return only the charts the caller can access on their own.
            result = [
