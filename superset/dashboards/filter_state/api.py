              ...
              application/json:
                ...
                examples:
                        time_grain_filter:
                          ...
                          description: "A stringified JSON for a time grain filter."
                          value: '{"id":"NATIVE_FILTER_ID","extraFormData":{"time_grain_sqla":"P1W/1970-01-03T00:00:00Z"},"filterState":{"label":"Week ending Saturday","value":["P1W/1970-01-03T00:00:00Z"]}}'
                        timecolumn_filter:
                          summary: "Time Column Filter"
                          description: "A stringified JSON for a time column filter."
                          value: '{"id":"NATIVE_FILTER_ID","extraFormData":{"granularity_sqla":"order_date"},"filterState":{"value":["order_date"]}}'
                        time_range_filter:
                          summary: "Time Range Filter"
                          description: "A stringified JSON representing a time range filter."
                          value: '{"id":"NATIVE_FILTER_ID","extraFormData":{"time_range":"DATEADD(DATETIME(\"2025-01-16T00:00:00\"), -7, day) : 2025-01-16T00:00:00"},"filterState":{"value":"DATEADD(DATETIME(\"2025-01-16T00:00:00\"), -7, day) : 2025-01-16T00:00:00"}}'
                        numerical_range_filter:
                          summary: "Numerical Range Filter"
                          description: "This body should be stringified and put into
                          value field."
                          value: '{"id":"NATIVE_FILTER_ID","extraFormData":{"filters":[{"col":"tz_offset","op":">=","val":[1000]},{"col":"tz_offset","op":"<=","val":[2000]}]},"filterState":{"value":[1000,2000],"label":"1000 <= x <= 200"}}'
                        value_filter:
                          summary: "Value Filter"
                          description: "This body should be stringified and put into
                          value field."
                          value: '{"id":"NATIVE_FILTER_ID","extraFormData":{"filters":[{"col":"real_name","op":"IN","val":["John Doe"]}]},"filterState":{"value":["John Doe"]}}'
          responses:
            201:
