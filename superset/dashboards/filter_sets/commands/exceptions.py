...
from superset.commands.exceptions import ForbiddenError, CreateFailedError, ObjectNotFoundError, UpdateFailedError, DeleteFailedError


class FilterSetNotFoundError(ObjectNotFoundError):
    def __init__(self, filterset_id: str = None, exception: Optional[Exception] = None) -> None:
        super().__init__('FilterSet', filterset_id, exception)


class FilterSetCreateFailedError(CreateFailedError):
    base_massage = 'CreateFilterSetCommand of dashboard "%s" failed: '
    def __init__(self, dashboard_id: str, reason: str = "",
                 exception: Optional[Exception] = None) -> None:
        super().__init__((self.base_massage % dashboard_id) + reason, exception)


class FilterSetUpdateFailedError(UpdateFailedError):
    base_massage = 'UpdateFilterSetCommand of filter_set "%s" failed: '
    def __init__(self, filterset_id: str, reason: str = "",
                 exception: Optional[Exception] = None) -> None:
        super().__init__((self.base_massage % filterset_id) + reason, exception)


class FilterSetDeleteFailedError(DeleteFailedError):
    base_massage = 'DeleteFilterSetCommand of filter_set "%s" failed: '
    def __init__(self, filterset_id: str, reason: str = "",
                 exception: Optional[Exception] = None) -> None:
        super().__init__((self.base_massage % filterset_id) + reason, exception)
...
class UserIsNotDashboardOwnerError(FilterSetCreateFailedError):
    ...
    def __init__(self, dashboard_id: str, exception: Optional[Exception] = None) -> None:
...
class FilterSetForbiddenError(ForbiddenError):
    ...
    def __init__(self, filterset_id: str, reason: str = '', exception: Optional[Exception] = None) -> None:
