...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getAjaxErrorMsg = getAjaxErrorMsg;
	/* eslint camelcase: 0 */
	...
	*/
	...
	function getParamObject(form_data, datasource_type) {
	  var data = {
	  ...
	  Object.keys(form_data).forEach(function (field) {
	    // filter out null fields
	    if (form_data[field] !== null && field !== 'datasource') {
	      data[field] = form_data[field];
	    }
	  });
	  var filterParams = formatFilters(form_data.filters);
	  Object.assign(data, filterParams);
	  return data;
	}

	function getAjaxErrorMsg(error) {
