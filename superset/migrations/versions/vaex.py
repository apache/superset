...
def upgrade():
    ...
    op.create_table('vaex_datasources',
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('vaex_datasource_id', sa.Integer(), nullable=True),
    sa.Column('created_by_fk', sa.Integer(), nullable=True),
    sa.Column('changed_by_fk', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['changed_by_fk'], ['ab_user.id'], ),
    sa.ForeignKeyConstraint(['created_by_fk'], ['ab_user.id'], ),
    sa.ForeignKeyConstraint(['vaex_datasource_id'], ['vaex_datasources.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('vaex_metrics',
    sa.Column('created_on', sa.DateTime(), nullable=True),
    sa.Column('changed_on', sa.DateTime(), nullable=True),
...
def upgrade2():
    op.add_column('vaex_metrics', sa.Column('warning_text', sa.Text(), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('vaex_metrics')
    op.drop_table('vaex_columns')
    op.drop_table('vaex_datasources')
    # ### end Alembic commands ###