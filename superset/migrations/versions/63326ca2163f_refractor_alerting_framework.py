...
Revision ID: 63326ca2163f
Revises: f80a3b88324b
Create Date: 2020-08-24 12:16:58.322254

"""

# revision identifiers, used by Alembic.
revision = "63326ca2163f"
...
def upgrade():
    ...
    op.alter_column(
        "alerts", "crontab", existing_type=mysql.VARCHAR(length=50), nullable=False
    )
...
def downgrade():
    ...
    op.alter_column(
        "alerts", "crontab", existing_type=mysql.VARCHAR(length=50), nullable=True
    )
