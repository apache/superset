...
class SnowflakeEngineSpec(PostgresBaseEngineSpec):
    ...
    time_grains = (
        ...
        Grain('5 minute', _('5 minute'),
              "DATEADD(MINUTE, FLOOR(DATE_PART(MINUTE, {col}) / 5) * 5, DATE_TRUNC('HOUR', {col}))",
              'PT5M'),
        Grain('10 minute', _('10 minute'),
              "DATEADD(MINUTE, FLOOR(DATE_PART(MINUTE, {col}) / 10) * 10, DATE_TRUNC('HOUR', {col}))",
              'PT5M'),
        Grain('15 minute', _('5 minute'),
              "DATEADD(MINUTE, FLOOR(DATE_PART(MINUTE, {col}) / 15) * 15, DATE_TRUNC('HOUR', {col}))",
              'PT5M'),
        Grain('30 minute', _('30 minute'),
              "DATEADD(MINUTE, FLOOR(DATE_PART(MINUTE, {col}) / 30) * 30, DATE_TRUNC('HOUR', {col}))",
              'PT30M'),
...
class MssqlEngineSpec(BaseEngineSpec):
    ...
    time_grains = (
        ...
        Grain('5 minute', _('5 minute'), 'DATEADD(minute, '
              ...
              'PT5M'),
        Grain('10 minute', _('10 minute'), 'DATEADD(minute, '
              'DATEDIFF(minute, 0, {col}) / 10 * 10, 0)',
              'PT10M'),
        Grain('15 minute', _('15 minute'), 'DATEADD(minute, '
...
class ClickHouseEngineSpec(BaseEngineSpec):
    ...
    time_grains = (
        ...
        Grain('10 minute', _('10 minute'),
              ...
              'PT10M'),
        Grain('15 minute', _('15 minute'),
              'toDateTime(intDiv(toUInt32(toDateTime({col})), 900)*900)',
              'PT15M'),
        Grain('30 minute', _('30 minute'),
              'toDateTime(intDiv(toUInt32(toDateTime({col})), 1800)*1800)',
              'PT30M'),
        Grain('hour', _('hour'),
