...
export default class MenuField extends React.Component {
  ...
  render() {
    ...
    const MenuWrap = this.props.freeForm ?
      (<Creatable {...menuProps} />) : 
      (<Menu {...menuProps}>
         <SubMenu title={menuTitle}>
            <MenuItem key="filter_box">
            <span><i className="fa fa-check-square icon-span"></i>
                <font size="2">提示器</font>
            </span>
            </MenuItem>
            <Divider />
            <MenuItem key="table">
            <span><i className="fa fa-table icon-span"></i>
                <font size="2">表格</font>
            </span>
            </MenuItem>
            ...
            <SubMenu title={barTitle} key="4-1">
                ...
                <span><i className="fa fa-bar-chart icon-span"></i>
                <font size="2">条形图</font>
                </span>
                </MenuItem>
                <MenuItem key="bar">
            ...
            <SubMenu title={areaTitle} key="4-4">
                <MenuItem key="area">
                <span><i className="fa fa-area-chart icon-span"></i>
                    <font size="2">面积图</font>
                </span>
                </MenuItem>
                <MenuItem key="area1">
            ...
            <MenuItem key="pie">
                <span><i className="fa fa-pie-chart icon-span"></i>
            ...
            <SubMenu title={meterTitle} key="6">
                <SubMenu title={hTitle} key="6-1">
                    ...
                    <span><i className="fa fa-header icon-span"></i>
                        <font size="2">大字图</font>
                    </span>
                    </MenuItem>
            ...
            <MenuItem key="bullet">
                <span><i className="fa fa-space-shuttle icon-span"></i>
                <font size="2">子弹图</font>
                </span>
            </MenuItem>
            <MenuItem key="6-3" disable="true">
                <span><i className="fa fa-tachometer icon-span"></i>
                <font size="2">仪表图</font>
                </span>
            </MenuItem>
            <MenuItem key="word_cloud" disable="true">
                <span><i className="fa fa-file-word-o icon-span"></i>
            ...
            <MenuItem key="world_map">
                <span><i className="fa fa-map-marker icon-span"></i>
            ...
            <MenuItem key="markup1">
                <span><i className="fa fa-file-code-o icon-span"></i>
                    <font size="2">叙述</font>
                </span>
            </MenuItem>
            <MenuItem key="markup">
            ...
            <MenuItem key="iframe">
                <span><i className="fa fa-columns icon-span"></i>
                    <font size="2">iframe</font>
                </span>
            </MenuItem>
            <MenuItem key="separator">
                <span><i className="fa fa-minus icon-span"></i>
