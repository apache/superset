...
import AdhocColumnOption from '../AdhocColumnOption';
...
//it's copy of AdhocFilterControl,so most of code is same and may be unwanted
export default class AdhocColumnControl extends React.Component {
...
AdhocColumnControl.propTypes = propTypes;
AdhocColumnControl.defaultProps = defaultProps;
