...
export const controls = {
  ...
  linear_color_scheme: {
    ...
    choices: [
      ...
      ['schemeRdBu', 'd3RdBu'],
      ['schemeRdGy', 'd3RdGy'],
      ['schemeRdYlBu', 'd3RdYlBu'],
      ['schemeRdYlGn', 'd3RdYlGn'],
      ['schemeSpectral', 'd3Spectral'],
      ['schemeBlues', 'd3Blues'],
      ['schemeGreens', 'd3Greens'],
      ['schemeGrays', 'd3Grays'],
      ['schemeOranges', 'd3Oranges'],
      ['schemePurples', 'd3Purples'],
      ['schemeReds', 'd3Reds'],
      ['schemeViridis', 'd3Viridis'],
      ['schemeInferno', 'd3Inferno'],
      ['schemeMagma', 'd3Magma'],
      ['schemePlasma', 'd3Plasma'],
      ['schemeWarm', 'd3Warm'],
      ['schemeCool', 'd3Cool'],
      ['schemeCubehelixDefault', 'd3CubehelixDefault'],
      ['schemeBuGn', 'd3BuGn'],
      ['schemeBuPu', 'd3BuPu'],
      ['schemeGnBu', 'd3GnBu'],
      ['schemeOrRd', 'd3OrRd'],
      ['schemePuBuGn', 'd3PuBuGn'],
      ['schemePuBu', 'd3PuBu'],
      ['schemePuRd', 'd3PuRd'],
      ['schemeRdPu', 'd3RdPu'],
      ['schemeYlGnBu', 'd3YlGnBu'],
      ['schemeYlGn', 'd3YlGn'],
      ['schemeYlOrBr', 'd3YlOrBr'],
      ['schemeYlOrRd', 'd3YlOrRd'],
    ],
