...
/**
 * Get a CSS class for styling a time series.
 *
 * The main time series should be styled as 'solid', and different time shifts
 * are assigned different sytles (dashed, dotted, dash-dotted, etc.).
 *
 * The function cycles through ten different styles while memoizing offsets
 * association to classes. If the function is called twice with the
 * same offset it will return the same class.
 *
 * @param {string} key - The time series key for which we want to get a class
 */
