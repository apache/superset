...
const vizMap = {
  ...
  [VIZ_TYPES.big_number]: () => loadVis(import(/* webpackChunkName: 'big_number-[request][index]' */ './big_number.js')),
  [VIZ_TYPES.big_number_total]: () => loadVis(import(/* webpackChunkName: "big_number" */ './big_number.js')),
  [VIZ_TYPES.box_plot]: loadNvd3,
  [VIZ_TYPES.bubble]: loadNvd3,
  [VIZ_TYPES.bullet]: loadNvd3,
  [VIZ_TYPES.cal_heatmap]: () => loadVis(import(/* webpackChunkName: "cal_heatmap" */ './cal_heatmap.js')),
  [VIZ_TYPES.compare]: loadNvd3,
  [VIZ_TYPES.directed_force]: () => loadVis(import(/* webpackChunkName: "directed_force" */ './directed_force.js')),
  [VIZ_TYPES.chord]: () => loadVis(import(/* webpackChunkName: "chord" */ './chord.jsx')),
  [VIZ_TYPES.dist_bar]: loadNvd3,
  [VIZ_TYPES.filter_box]: () => loadVis(import(/* webpackChunkName: "filter_box" */ './filter_box.jsx')),
  [VIZ_TYPES.heatmap]: () => loadVis(import(/* webpackChunkName: "heatmap" */ './heatmap.js')),
  [VIZ_TYPES.histogram]: () => loadVis(import(/* webpackChunkName: "histogram" */ './histogram.js')),
  ...
  [VIZ_TYPES.para]: () => loadVis(import(/* webpackChunkName: "parallel_coordinates" */ './parallel_coordinates.js')),
  [VIZ_TYPES.pie]: loadNvd3,
  [VIZ_TYPES.pivot_table]: () => loadVis(import(/* webpackChunkName: "pivot_table" */ './pivot_table.js')),
  ...
  [VIZ_TYPES.time_table]: () => loadVis(import(/* webpackChunkName: "time_table" */ './time_table.jsx')),
  [VIZ_TYPES.treemap]: () => loadVis(import(/* webpackChunkName: "treemap" */ './treemap.js')),
  [VIZ_TYPES.country_map]: () => loadVis(import(/* webpackChunkName: "country_map" */ './country_map.js')),
  [VIZ_TYPES.word_cloud]: () => loadVis(import(/* webpackChunkName: "word_cloud" */ './word_cloud.js')),
  [VIZ_TYPES.world_map]: () => loadVis(import(/* webpackChunkName: "world_map" */ './world_map.js')),
  ...
  [VIZ_TYPES.deck_screengrid]: () => loadVis(import(/* webpackChunkName: "deckgl/layers/screengrid" */ './deckgl/layers/screengrid.jsx')),
  [VIZ_TYPES.deck_grid]: () => loadVis(import(/* webpackChunkName: "deckgl/layers/grid" */ './deckgl/layers/grid.jsx')),
  [VIZ_TYPES.deck_hex]: () => loadVis(import(/* webpackChunkName: "deckgl/layers/hex" */ './deckgl/layers/hex.jsx')),
  [VIZ_TYPES.deck_path]: () => loadVis(import(/* webpackChunkName: "deckgl/layers/path" */ './deckgl/layers/path.jsx')),
  [VIZ_TYPES.deck_geojson]: () => loadVis(import(/* webpackChunkName: "deckgl/layers/geojson" */ './deckgl/layers/geojson.jsx')),
  [VIZ_TYPES.deck_arc]: () => loadVis(import(/* webpackChunkName: "deckgl/layers/arc" */ './deckgl/layers/arc.jsx')),
  [VIZ_TYPES.deck_polygon]: () => loadVis(import(/* webpackChunkName: "deckgl/layers/polygon" */ './deckgl/layers/polygon.jsx')),
  [VIZ_TYPES.deck_multi]: () => loadVis(import(/* webpackChunkName: "deckgl/multi" */ './deckgl/multi.jsx')),
