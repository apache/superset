...
(time /home/travis/build/lyft/incubator-superset/superset/bin/superset db upgrade; time /home/travis/build/lyft/incubator-superset/superset/bin/superset load_test_users; /home/travis/build/lyft/incubator-superset/superset/bin/superset load_examples --load-test-data; time /home/travis/build/lyft/incubator-superset/superset/bin/superset init; echo "[completed python build steps]"; flask run -p 8081 --with-threads --reload --debugger) &
