...
const vizMap = {
  ...
  [VIZ_TYPES.deck_scatter]: require('./deckgl/layers/scatter.jsx'),
  [VIZ_TYPES.deck_screengrid]: require('./deckgl/layers/screengrid.jsx'),
  [VIZ_TYPES.deck_grid]: require('./deckgl/layers/grid.jsx'),
  [VIZ_TYPES.deck_hex]: require('./deckgl/layers/hex.jsx'),
  [VIZ_TYPES.deck_path]: require('./deckgl/layers/path.jsx'),
  [VIZ_TYPES.deck_geojson]: require('./deckgl/layers/geojson.jsx'),
  [VIZ_TYPES.deck_arc]: require('./deckgl/layers/arc.jsx'),
  [VIZ_TYPES.deck_polygon]: require('./deckgl/layers/polygon.jsx'),
