...
describe('getPlaySliderParams', () => {
  ...
  it('handles durations', () => {
    const timestamps = [
      ...
      new Date('2018-01-02').getTime(),
      new Date('2018-01-03').getTime(),
      new Date('2018-01-04').getTime(),
      new Date('2018-01-05').getTime(),
      new Date('2018-01-06').getTime(),
      new Date('2018-01-07').getTime(),
      new Date('2018-01-08').getTime(),
      new Date('2018-01-09').getTime(),
      new Date('2018-01-10').getTime(),
    ];
