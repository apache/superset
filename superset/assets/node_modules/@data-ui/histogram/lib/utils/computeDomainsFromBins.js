...
exports.default = computeDomainsFromBins;
...
function computeDomainsFromBins(_ref) {
  ...
  Object.values(binsByIndex).forEach(function (bins) {
    var currValueMax = (0, _d3Array.max)(bins, function (d) {
      return d[valueKey];
    });
  ...
  if (!Array.isArray(binDomain)) {
    binDomain = Object.keys(binDomain).sort(_caseInsensitiveSort.default);
  }
