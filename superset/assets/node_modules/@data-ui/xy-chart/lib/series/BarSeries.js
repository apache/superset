...
function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var offset = categoryScale.offset || 0;
    var Labels = []; // Labels on top

    return _react.default.createElement(_group.Group, {
      style: disableMouseEvents ? noEventsStyles : null
    }, data.map(function (d, i) {
      var barPosition = categoryScale(categoryField(d)) - offset;
      var barLength = horizontal ? valueScale(valueField(d)) : maxBarLength - valueScale(valueField(d));
