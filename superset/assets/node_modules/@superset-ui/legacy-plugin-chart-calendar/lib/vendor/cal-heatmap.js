...
function o(e,t){var o=n.options.cellSize*n._domainType[n.options.subDomain].row(e)+n.options.cellPadding*n._domainType[n.options.subDomain].row(e);return 2===arguments.length&&!0===t&&(o+=n.options.domainGutter+n.domainVerticalLabelHeight+n.options.domainMargin[0]+n.options.domainMargin[2]),o}/**
   ...
   */var n=this;for(var i in n.tip=(0,_d3Tip.default)().attr("class","d3-tip").direction("n").offset([-5,0]).html(function(e){return"\n      "+n.options.timeFormatter(e.t)+": <strong>"+n.options.valueFormatter(e.v)+"</strong>\n    "}),n.legendTip=(0,_d3Tip.default)().attr("class","d3-tip").direction("n").offset([-5,0]).html(function(e){return n.options.valueFormatter(e)}),this.allowedDataType=["json","csv","tsv","txt"],this.options={// selector string of the container to append the graph to
...
return!1;return!0}var _default=CalHeatMap;exports.default=_default;