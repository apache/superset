"use strict";exports.__esModule=!0,exports.cleanColorInput=cleanColorInput,exports.getTimeOrNumberFormatter=getTimeOrNumberFormatter,exports.drawBarValues=drawBarValues,exports.generateRichLineTooltipContent=generateRichLineTooltipContent,exports.generateMultiLineTooltipContent=generateMultiLineTooltipContent,exports.generateBubbleTooltipContent=generateBubbleTooltipContent,exports.hideTooltips=hideTooltips,exports.wrapTooltip=wrapTooltip,exports.tipFactory=tipFactory,exports.getMaxLabelSize=getMaxLabelSize,exports.formatLabel=formatLabel,exports.computeBarChartWidth=computeBarChartWidth,exports.tryNumify=tryNumify,exports.stringifyTimeRange=stringifyTimeRange,exports.setAxisShowMaxMin=setAxisShowMaxMin,exports.computeYDomain=computeYDomain;var _d=_interopRequireDefault(require("d3")),_d3Tip=_interopRequireDefault(require("d3-tip")),_dompurify=_interopRequireDefault(require("dompurify")),_numberFormat=require("@superset-ui/number-format"),_timeFormat=require("@superset-ui/time-format");function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}/**
...
var b=+a;return Number.isNaN(b)?a:b}function stringifyTimeRange(a){return a.some(function(a){return void 0===a.toISOString})?null:a.map(function(a){return a.toISOString().slice(0,-1)}).join(" : ")}function setAxisShowMaxMin(a,b){a&&a.showMaxMin&&b!==void 0&&a.showMaxMin(b)}function computeYDomain(a){if(Array.isArray(a)&&0<a.length&&Array.isArray(a[0].values)){var b=a.map(function(a){return _d.default.extent(a.values,function(a){return a.y})}),c=_d.default.min(b,function(a){var b=a[0];return b}),d=_d.default.max(b,function(a){var b=a[1];return b});return[c,d]}return[0,1]}