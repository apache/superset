...
var logException = function logException(error, errorInfo) {
  lastError.push({ error: error, errorInfo: errorInfo });
  initErrorOverlay();
};
...
var AppContainer = function (_React$Component) {
  ...
  AppContainer.prototype.render = function render() {
    ...
    if (error && this.props.errorBoundary) {
      return React__default.createElement(ErrorReporter, { error: error, errorInfo: errorInfo });
    }
...
var compareComponents = function compareComponents(oldType, newType, setNewType) {
...
var hotComponentCompare = function hotComponentCompare(oldType, newType, setNewType) {
...
var markUpdate = function markUpdate(_ref) {
  ...
  fiber.memoizedProps = Object.assign({ cacheBusterProp: true }, fiber.memoizedProps);
};
...
function componentRender() {
  ...
  if (error && generation === get$1()) {
    return React__default.createElement(configuration.errorReporter || EmptyErrorPlaceholder, { error: error, errorInfo: errorInfo });
  }
  try {
