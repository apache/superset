...
function assembleGetUniforms(modules) {
  return function getUniforms(opts) {
    ...
    for (const moduleName of modules) {
      const shaderModule = getShaderModule(moduleName); // `modules` is already sorted by dependency level. This guarantees that
      // modules have access to the uniforms that are generated by their dependencies.

      const moduleUniforms = shaderModule.getUniforms ? shaderModule.getUniforms(opts, uniforms) : {};
