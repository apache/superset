...
const ERR_ARGUMENT = 'UniformBufferLayout illegal argument'; // Local constants - these will "collapse" during minification
...
const GL_FLOAT_MAT4x3 = 0x8B6A; // Uniform table for std140
...
const UNIFORM_TYPES = {
  ...
  [GL_FLOAT_MAT2]: [GL_FLOAT, 8],
  // 4
  [GL_FLOAT_MAT2x3]: [GL_FLOAT, 8],
  // 6
  [GL_FLOAT_MAT2x4]: [GL_FLOAT, 8],
  // 8
  [GL_FLOAT_MAT3]: [GL_FLOAT, 12],
  // 9
  [GL_FLOAT_MAT3x2]: [GL_FLOAT, 12],
  // 6
  [GL_FLOAT_MAT3x4]: [GL_FLOAT, 12],
  // 12
  [GL_FLOAT_MAT4]: [GL_FLOAT, 16],
  // 16
  [GL_FLOAT_MAT4x2]: [GL_FLOAT, 16],
  // 8
...
export default class UniformBufferLayout {
  ...
  _addUniform(key, uniformType) {
    ...
    const _definition = _slicedToArray(definition, 2),
          type = _definition[0],
    ...
    const offset = this.size; // Then, add our object's padded size ((1, 2, multiple of 4) to the current offset
