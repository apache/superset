...
export default class Buffer extends Resource {
  constructor(gl, opts = {}) {
    super(gl, opts); // In WebGL1, we need to make sure we use GL.ELEMENT_ARRAY_BUFFER when
  ...
  bind({
    ...
    const type = target === GL_UNIFORM_BUFFER || target === GL_TRANSFORM_FEEDBACK_BUFFER ? size !== undefined ? 'ranged' : 'indexed' : 'non-indexed';
