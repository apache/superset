...
const WEBGL_PARAMETERS = {
  ...
  [GL.MAX_ELEMENT_INDEX]: // Guess: per webglstats.com 99.6% of webgl2 supports 2147483647
  gl => gl.getExtension(OES_element_index) ? 2147483647 : 65535,
  [GL.MAX_ELEMENTS_INDICES]: // Guess: "Reasonably safe" per webglstats.com - could be higher/lower (on some mobile devices)
  gl => gl.getExtension(OES_element_index) ? 16777216 : 65535,
  [GL.MAX_ELEMENTS_VERTICES]: // Guess: "Reasonably safe" per webglstats.com - could be higher/lower (on some mobile devices)
  gl => 16777216,
