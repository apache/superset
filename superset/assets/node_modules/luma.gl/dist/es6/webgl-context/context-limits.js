...
export function getGLContextInfo(gl) {
  ...
  if (!gl.luma.info) {
    ...
    gl.luma.info = {
      ...
      [GL.UNMASKED_VENDOR_WEBGL]: gl.getParameter(info && info.UNMASKED_VENDOR_WEBGL || GL.VENDOR),
      [GL.UNMASKED_RENDERER_WEBGL]: gl.getParameter(info && info.UNMASKED_RENDERER_WEBGL || GL.RENDERER),
