...
export function getRealContext(gl) {
  ...
  const data = getContextData(gl); // If the context has a realContext member, it is a debug context so return the realContext
...
export function getDebugContext(gl) {
  ...
  const data = getContextData(gl); // If this *is* a debug context, return itself
