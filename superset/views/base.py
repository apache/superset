...
FRONTEND_CONF_KEYS = (
    ...
    "NATIVE_FILTER_RETRY_MAX_ATTEMPTS",
    "NATIVE_FILTER_RETRY_INITIAL_DELAY",
    "NATIVE_FILTER_RETRY_MAX_DELAY",
    "NATIVE_FILTER_RETRY_BACKOFF_MULTIPLIER",
    "NATIVE_FILTER_RETRY_STAGGER_MAX_OFFSET",
