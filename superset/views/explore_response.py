...
class ExploreResponse():
    ...
    @staticmethod
    def get_datasource_data(datasources: List):
        """
    ...
    def get_column_aliases(columns: List[Dict[str, Any]], alias: str) -> List[str]:
        ...
        for column in columns:
            ...
            if expression:
                column_name = ExploreResponse.get_calculated_column_expression(columns, expression, alias)
                column_expressions[column_name] = column_name
            else:
                column_name = "{}.{}".format(alias, column_name)
            column_alias = "{}_{}".format(alias, ExploreResponse.replace_special_characters(column_name))
            renamed_columns.append("{} {}".format(column_name, column_alias))
    ...
    def multiple_dataset(self):
        ...
        datasource_ids, datasource_types  = self.get_datasource_data(additional_datasources)
