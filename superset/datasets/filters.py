...
class FilterAdvancedDataType(BaseFilter):  # pylint: disable=too-few-public-methods
    name = _("Advanced Data Type")
    arg_name = "advanced_data_type"

    def apply(self, query: Query, value: Optional[Any]) -> Query:
        return (
            query.add_columns(SqlaTable.id)
            .join(TableColumn, TableColumn.table_id == SqlaTable.id)
            .filter(TableColumn.advanced_data_type == cast(str, value))
