...
class DatasetFilterRestApi(BaseSupersetModelRestApi):
    ...
    def delete(  # pylint: disable=arguments-differ
        self, pk: int, filter_id: int
    ) -> Response:
        """Delete a dataset filter.
        ---
        delete:
          summary: Delete a dataset filter
          parameters:
          - in: path
            schema:
              type: integer
          ...
          - in: path
            schema:
              type: integer
            name: filter_id
            description: The filter id for this dataset
          responses:
            200:
        ...
        """
        try:
            DeleteDatasetFilterCommand(pk, filter_id).run()
            return self.response(200, message="OK")
        except DatasetFilterNotFoundError:
            return self.response_404()
        except DatasetFilterForbiddenError:
