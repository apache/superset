...
DEFAULT_FEATURE_FLAGS: dict[str, bool] = {
    ...
    # Requires Redis and Celery workers; implies GLOBAL_TASK_FRAMEWORK.
    # @lifecycle: testing
    ...
    # Enable task admission, APIs (including polling/cancellation), MCP and Tasks UI.
    # Infrastructure is registered at boot regardless of this runtime flag.
    # @lifecycle: testing
