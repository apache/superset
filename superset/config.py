...
# The available list is generated by driver installed, and some drivers have multiple
# engines.
# e.g., DBS_AVAILABLE_BLACKLIST: Dict[str, Tuple[str, ...]] = {"databricks": ("pyhive", "pyodbc")}
