...
FLASH_CREATION = {
    ...
    "JSONSCHEMA": {
        ...
        "properties": {
            ...
            "domainName": {"type": "string", "title": "Domain", "pattern": "^[a-zA-Z0-9-]+(?:_[a-zA-Z0-9-]+)*$"},
            "serviceName": {"type": "string", "title": "Service","pattern": "^[a-zA-Z0-9-]+(?:_[a-zA-Z0-9-]+)*$"},
            "datasetName": {"type": "string", "title": "Dataset","pattern": "^[a-zA-Z0-9-]+(?:_[a-zA-Z0-9-]+)*$"},
            "tableName": {
                "type": "string",
                "title": "Table Name",
                "readOnly": True,
