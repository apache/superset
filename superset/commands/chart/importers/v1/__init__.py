...
from superset_core.common.models import Subject  # noqa: F401
...
class ImportChartsCommand(ImportModelsCommand):
    ...
    def _import_chart_with_tags(
        ...
        default_viewers: list[Subject],
        imported_chart_ids: dict[str, int],
        annotation_layer_ids: dict[str, int] | None = None,
    ) -> None:
        """
        Import one chart, record its UUID-to-ID mapping,
        and import tags when enabled.
        """
