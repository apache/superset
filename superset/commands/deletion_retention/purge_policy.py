        ...
        SqlaTable: PurgeEntityPolicy(
            ...
            dependencies=policies(
                (
                    ...
                    fk("tables", "sql_filters", "id", "table_id", "inbound"),
                    ...
                    fk("sql_filters", "ab_user", "changed_by_fk", "id", "outbound"),
                    fk("sql_filters", "ab_user", "created_by_fk", "id", "outbound"),
                    fk("sql_filters", "tables", "table_id", "id", "outbound"),
