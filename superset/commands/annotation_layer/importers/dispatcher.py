...
command_versions = [
    v1.ImportAnnotationLayersCommand,
]


class ImportAnnotationLayersCommand(BaseCommand):
    """
    ...
    def __init__(self, contents: dict[str, str], *args: Any, **kwargs: Any):
        """
        Store the file contents and any extra args forwarded to versioned commands.
        """
    ...
    def run(self) -> None:
        """
        Try each versioned importer in order;
        raise CommandInvalidError if none match.
        """
