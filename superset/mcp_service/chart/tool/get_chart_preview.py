    ...
    try:
        ...
        with event_logger.log_context(action="mcp.get_chart_preview.chart_lookup"):
            ...
            if not request.identifier and request.form_data_key:
                ...
                # Ensure SQLAlchemy state is fresh while a session is active.
                # Downstream commands may commit before strategy classes read
                # chart attributes; refresh() pre-loads them to avoid
