...
async def generate_chart(  # noqa: C901
    ...
    - MUST include chart_type in config (one of: 'xy', 'table', 'pie',
      'gauge', 'treemap_v2', 'heatmap_v2', 'pivot_table', 'mixed_timeseries',
    ...
    - chart_type='heatmap_v2' for a two-dimensional density grid.
      Required fields: x_axis, y_axis, metric
    ...
    - "heatmap" / "density grid" -> chart_type='heatmap_v2'
