...
async def generate_chart(  # noqa: C901
    ...
    - MUST include chart_type in config (one of: 'xy', 'table', 'pie',
      'gauge', 'treemap_v2', 'bubble_v2', 'radar', 'pivot_table', 'mixed_timeseries',
    ...
    - chart_type='radar' for multi-metric comparison on radial axes.
      Required fields: metrics (one axis each); optional: groupby (one
      polygon per value)
    ...
    - "radar" / "spider" / "multi-metric comparison" -> chart_type='radar'
