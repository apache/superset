...
async def generate_chart(  # noqa: C901
    ...
    - MUST include chart_type in config (one of: 'xy', 'table', 'pie',
      'gauge', 'treemap_v2', 'funnel', 'pivot_table', 'mixed_timeseries',
    ...
    - chart_type='funnel' for a funnel of stages by a metric.
      Required fields: dimension (the stages), metric
    ...
    - "funnel" / "conversion funnel" -> chart_type='funnel'
