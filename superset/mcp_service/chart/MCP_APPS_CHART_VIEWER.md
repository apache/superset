...
render_chart tool ──► get_chart_data_core ──► ChartDataCommand (RBAC + RLS)
  ...
  │  tool descriptor carries _meta.ui.resourceUri = ui://superset/chart-viewer/v4-<digest>
  ▼
...
renders the widget; the `ui://superset/chart-viewer/v4-<digest>` resource loads.
