...
@mcp_auth_hook(class_permission_name="Dataset", method_permission_name="write")
async def update_dataset_metric(  # noqa: C901
    ...
    try:
        ...
        # Enforce ownership before touching the metric list. Otherwise a caller
        ...
        # lookup below would have already leaked that information — so this must
        # stay in step with the command's own check (raise_for_ownership).
        try:
