...
>
> 🔐 **Need authentication?** See the [Authentication Guide](./authentication.mdx) for JWT setup.
>
> 🔧 **Want to add tools?** Check the [Development Guide](./development.mdx#adding-new-tools) for step-by-step instructions.
...
Set up authentication and security with the [Authentication Guide](./authentication.mdx).

### 🔧 **Want to Add More Tools?**
Learn how to extend the MCP service in the [Development Guide](./development.mdx).

### 🏗️ **Need Architecture Details?**
Understand the system design in the [Architecture Overview](./architecture.mdx).

### 🏢 **Enterprise Features?**
Explore advanced capabilities in the [Preset Integration Guide](./preset-integration.mdx).
