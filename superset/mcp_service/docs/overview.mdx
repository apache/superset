...
### Ready to Use MCP?
- **[📚 API Reference](./api-reference.mdx)** - Try all 16 tools with request/response examples
- **[🔐 Authentication](./authentication.mdx)** - Set up JWT security for production use

### Want to Extend MCP?
- **[🔧 Development Guide](./development.mdx)** - Learn internal architecture and add new tools
- **[🏗️ Architecture](./architecture.mdx)** - Understand system design and deployment patterns

### Enterprise Deployment?
- **[🏢 Preset Integration](./preset-integration.mdx)** - RBAC extensions and OIDC integration for enterprise

> 💡 **Not sure where to go?** Check the [Documentation Index](./README.md) for guided paths by role and use case.
