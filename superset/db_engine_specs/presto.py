...
class PrestoEngineSpec(BaseEngineSpec):
    ...
    _column_type_mappings = (
        (types.Boolean(), re.compile(r"^boolean.*", re.IGNORECASE)),
        (TinyInteger(), re.compile(r"^tinyint.*", re.IGNORECASE)),
        (types.SmallInteger(), re.compile(r"^smallint.*", re.IGNORECASE)),
        (types.Integer(), re.compile(r"^integer.*", re.IGNORECASE)),
        (types.BigInteger(), re.compile(r"^bigint.*", re.IGNORECASE)),
        (types.Float(), re.compile(r"^real.*", re.IGNORECASE)),
        (types.Float(), re.compile(r"^double.*", re.IGNORECASE)),
        (types.DECIMAL(), re.compile(r"^decimal.*", re.IGNORECASE)),
        (types.String(), re.compile(r"^varchar.*", re.IGNORECASE),),
        (types.CHAR(), re.compile(r"^char.*", re.IGNORECASE)),
        (types.VARBINARY(), re.compile(r"^varbinary.*", re.IGNORECASE)),
        (types.JSON(), re.compile(r"^json.*", re.IGNORECASE)),
        (types.DATE(), re.compile(r"^date.*", re.IGNORECASE)),
        (types.Time(), re.compile(r"^time.*", re.IGNORECASE)),
        (types.TIMESTAMP(), re.compile(r"^timestamp.*", re.IGNORECASE)),
        (Interval(), re.compile(r"^interval.*", re.IGNORECASE)),
        (Array(), re.compile(r"^array.*", re.IGNORECASE),),
        (Map(), re.compile(r"^map.*", re.IGNORECASE)),
        (Row(), re.compile(r"^row.*", re.IGNORECASE),),
    )
