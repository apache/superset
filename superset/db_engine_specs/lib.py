    ...
    output.update(
        {
            ...
            "order_by_alias_to_source_column": not spec.order_by_allows_alias_to_source_column,
            "group_by_alias_to_source_column": not spec.group_by_allows_alias_to_source_column,
