...
class TestBundleCommand:
    """Test suite for the bundle command."""

    def setup_extension_for_bundling(self, base_path: Path) -> None:
    ...
    def test_bundle_command_creates_zip_with_default_name(
        self, mock_build, cli_runner, isolated_filesystem
    ):
        ...
        self.setup_extension_for_bundling(isolated_filesystem)
