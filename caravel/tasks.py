...
@celery_app.task
def get_sql_results(database_id, sql, user_id, tmp_table_name=""):
    ...
    query_result = get_sql_results_as_dict(
        sql, db_to_query, query.tmp_table_name)
...
def get_sql_results_as_dict(sql, db_to_query, tmp_table_name):
