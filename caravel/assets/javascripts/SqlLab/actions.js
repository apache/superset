...
export function setFilterDatabases(filterDatabases) {
  return { type: SET_FILTER_DATABASES, filterDatabases };
}

export function setQueryFilter(queryFilter) {
  return { type: SET_QUERY_FILTER, queryFilter };
}
