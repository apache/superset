...
<StoryWithControls
  ...
  sampleChildren={[{"component":"Col","props":{"span":6,"children":"col-6","style":{"background":"#e6f4ff","padding":"8px","border":"1px solid #91caff","textAlign":"center"}}},{"component":"Col","props":{"span":6,"children":"col-6","style":{"background":"#e6f4ff","padding":"8px","border":"1px solid #91caff","textAlign":"center"}}},{"component":"Col","props":{"span":6,"children":"col-6","style":{"background":"#e6f4ff","padding":"8px","border":"1px solid #91caff","textAlign":"center"}}},{"component":"Col","props":{"span":6,"children":"col-6","style":{"background":"#e6f4ff","padding":"8px","border":"1px solid #91caff","textAlign":"center"}}}]}
/>
...
|------|------|---------|-------------|
| `align` | `string` | `"top"` | Vertical alignment of flex items. |
| `justify` | `string` | `"start"` | Horizontal arrangement of flex items. |
| `wrap` | `boolean` | `true` | Whether the flex container is allowed to wrap its items. |
| `span` | `number` | `6` | Number of grid columns to span (out of 24). |
| `offset` | `number` | `0` | Number of grid columns to offset from the left. |
