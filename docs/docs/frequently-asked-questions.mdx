...
may work but isn’t tested (though Microsoft SQL Server has been [reported *not* to
work](https://github.com/apache/superset/issues/18961) as a Superset backend). Column-store,
non-OLTP databases are not designed for this type of workload.

Superset has been [reported *not* to work](https://github.com/apache/superset/issues/18961) with Microsoft SQL Server as a backend.
