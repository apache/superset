...
Superset includes example datasets stored as DuckDB files in `superset/examples/data/`. These are automatically discovered and loaded when running `superset load-examples`. To add a new example dataset:

1. Create a DuckDB file with your data
2. Place it in `superset/examples/data/`
3. The dataset will be auto-discovered on the next load
