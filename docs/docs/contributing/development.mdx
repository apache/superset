...
curl -f http://localhost:8080/health && echo "✅ WebSocket ready"
```
...
- Reference [LLMS.md](https://github.com/apache/superset/blob/master/LLMS.md) for comprehensive development guidelines and context
- Follow the TypeScript migration guidelines and code standards in LLMS.md
