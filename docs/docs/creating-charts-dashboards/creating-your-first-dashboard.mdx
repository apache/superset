...
<img src={useBaseUrl("/img/tutorial/tutorial_01_add_database_connection.png" )} />{" "} <br/><br/>

Then select your database type in the resulting modal:

<img src={useBaseUrl("/img/tutorial/tutorial_02_select_database.png" )} />{" "} <br/><br/>
...
<img src={useBaseUrl("/img/tutorial/tutorial_03a_database_connection_string_link.png" )} />{" "} <br/><br/>
