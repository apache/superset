...
Complete reference for all 17 MCP tools, 2 prompts, and 2 resources with request/response examples.
...
Personalized onboarding prompt that guides new users through their first Superset experience.

**Parameters:**
```json
{
  "user_type": "analyst",         // Options: analyst, executive, developer
  "focus_area": "sales"          // Options: sales, marketing, operations, general
}
```

**Response Example:**
The prompt returns a personalized message that:
- Welcomes the user based on their role
- Focuses on relevant datasets for their area
- Lists the tools that will be used
- Provides a step-by-step guide for getting started

**Usage in Claude Desktop:**
Simply ask "Help me get started with Superset" and Claude will automatically use this prompt.

### create_chart_guided

Step-by-step guidance for creating charts based on business goals.

**Parameters:**
```json
{
  "chart_type": "bar",           // Options: auto, bar, line, pie, table
  "business_goal": "reporting"   // Options: exploration, reporting, monitoring
}
```

**Response Example:**
The prompt returns guidance that:
- Explains why the chosen chart type fits the goal
- Lists required data structure
- Provides configuration examples
- Suggests best practices for the visualization

**Usage in Claude Desktop:**
Ask "Guide me through creating a bar chart for reporting" and Claude will use this prompt.

## MCP Resources

### superset://instance/metadata

Provides comprehensive metadata about the Superset instance, including statistics, popular content, and configuration.
...
```json
{
  ...
  "available_chart_types": [
    "line", "bar", "area", "scatter", "pie", "table",
    "pivot_table", "heatmap", "box_plot", "histogram"
  ],
  "database_engines": ["postgresql", "mysql", "sqlite"],
  "sample_queries": [
    {
      "description": "Top 10 by metric",
      "template": "SELECT dimension, SUM(metric) as total..."
    }
  ],
  "features": {
...
**Usage in Claude Desktop:**
This resource is automatically accessed when Claude needs context about your Superset instance.

### superset://chart/templates

Provides pre-configured chart templates, color schemes, and best practices for creating effective visualizations.
...
```json
{
  "templates": {
    "line_chart": {
      ...
      "viz_type": "echarts_timeseries_line",
      "configuration": {
        "x_axis": "temporal column",
        "y_axis": "metric or numeric column",
        "group_by": "optional dimension"
      },
      "best_practices": [
    ...
    "bar_chart": { /* similar structure */ },
    "pie_chart": { /* similar structure */ }
  },
  "color_schemes": {
    "default": ["#1f77b4", "#ff7f0e", "#2ca02c"],
    "colorblind_safe": ["#0173B2", "#CC78BC", "#029E73"]
  },
  "performance_tips": [
    "Use time grain for large date ranges",
...
**Usage in Claude Desktop:**
This resource is automatically accessed when Claude helps you create or optimize charts.
