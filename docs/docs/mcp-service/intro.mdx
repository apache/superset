...
**✅ Phase 1 Complete - Production Ready** with 17 tools, 2 prompts, and 2 resources.

## What is MCP?

The Model Context Protocol (MCP) is an open standard that allows AI assistants to securely connect to data sources and tools. Superset's MCP service exposes **17 production-ready tools**, **2 guided prompts**, and **2 contextual resources** that enable:
...
### 🔧 **17 Production Tools, 2 Prompts, 2 Resources**
...
| **System** (2) | Instance info, explore links | Quickstart | Instance metadata | System integration |
