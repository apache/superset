...
## Alternative: Local Development with MCP Service

If you prefer to run Superset directly on your machine (without Docker) and want to include the MCP (Model Context Protocol) service for AI-powered features, you can use our streamlined setup:
...
The `make mcp-setup` command provides an interactive setup that:
- Creates a Python virtual environment
- Installs all dependencies
- Configures Superset with secure defaults
- Initializes the database
- Creates an admin user (admin/admin)
- Optionally configures AI features via MCP
