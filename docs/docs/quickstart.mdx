...
- [Using Docker Compose](/docs/installation/docker-compose): find
...
- [Configure Superset](/docs/configuration/configuring-superset/): Superset is highly configurable.
  Find out what the options are here.
- [Installing on Kubernetes](/docs/installation/kubernetes/): if you'd like to setup
