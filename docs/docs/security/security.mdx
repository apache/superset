...
> **Note**  
> `https://app.snap4idtcity.com` is already included in the default `connect-src`
> allowlist so dashboards can call that IoT endpoint immediately. Use the environment
> variable when you need to add additional domains.
