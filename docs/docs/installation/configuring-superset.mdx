...
The following is an example of some of the parameters you can set in your `superset_config.py` file:
```
...
# You MUST set this for production environments or the server will not start.
...
`PREVIOUS_SECRET_KEY = `and provide your new key as `SECRET_KEY =`.  You can find your current SECRET_KEY with these commands:
