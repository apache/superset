...
Default security settings and passwords are included but you **SHOULD** override those with your own for `dev` instances, and **MUST** update them to run `prod` instances, in particular:
