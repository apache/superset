...
:::resources
- [Official Helm Chart Repository](https://github.com/apache/superset/tree/master/helm/superset)
- [Superset Helm Integration Guide](https://www.restack.io/docs/superset-knowledge-apache-superset-helm-integration)
:::
