...
Check this by installing `curl` in your worker's environment, then attempt to `curl` the URL of a report that you see in the error logs of your worker.  TODO: PROVIDE URL TO TRY EVEN IF THERE IS NOT AN ERROR IN THE LOG.
