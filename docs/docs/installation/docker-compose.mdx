...
- [superset_config_docker.py](./custom_docker_compose_installation_files/superset_config_docker.py): custom configuration file, overriding the default [superset_config.py file](../../../docker/python_dev/superset_config.py)
