...
keywords:
  [superset faq, superset questions, superset help, data visualization faq]
---
...
<FAQSchema
  faqs={[
    ...
    {
      question: 'Can I hide an unavailable Druid database from SQL Lab?',
      answer:
        'Yes. Edit the existing Druid connection and uncheck Expose database in SQL Lab. Keep the database name and connection settings unchanged. If the connection check fails during permission synchronization, Superset saves the option and logs a warning without deleting the connection, datasets, or charts.',
    },
    {
...
## Can I hide an unavailable Druid database from SQL Lab?

Yes. Edit the existing Druid connection and uncheck **Expose database in SQL Lab**.
Keep its database name and connection settings unchanged. If the connection check fails
during permission synchronization, Superset saves the option and logs a warning without
deleting the connection, datasets, or charts. Changes to the database name, credentials,
or other connection settings still require successful synchronization.
