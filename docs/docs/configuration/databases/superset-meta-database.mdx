...
description: "Documentation for Superset meta database database connection."
---
...
<DatabasePage name="Superset meta database" database={databaseData.databases["Superset meta database"]} />
