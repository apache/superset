...
description: "Documentation for Aurora MySQL (Data API) database connection."
---
...
<DatabasePage name="Aurora MySQL (Data API)" database={databaseData.databases["Aurora MySQL (Data API)"]} />
