...
description: "Documentation for Aurora PostgreSQL (Data API) database connection."
---
...
<DatabasePage name="Aurora PostgreSQL (Data API)" database={databaseData.databases["Aurora PostgreSQL (Data API)"]} />
