---
title: Database Engine Specifications
hide_title: false
sidebar_position: 3
version: 1
---
...
export const database_information = [
...
export const time_grains_common = [
...
export const time_grains_extended = [
...
import DatabaseTable from '../../src/components/DatabaseTable';
...
<DatabaseTable items={feature_overview} />

### Database Information


<DatabaseTable items={database_information} />


### SQL Capabilities

<DatabaseTable items={sql_capabilities} />


### Time Grains – Common

<DatabaseTable items={time_grains_common} />


### Time Grains – Extended

<DatabaseTable items={time_grains_extended} />
...
<DatabaseTable items={metadata_features} />


### Operational & Advanced Features

<DatabaseTable items={advanced_features} />
