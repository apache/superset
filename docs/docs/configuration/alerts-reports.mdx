...
- You can see the dedicated docs about [Kubernetes installation](/docs/installation/kubernetes) for more generic details.
...
You can find documentation about each field in the default `config.py` in the GitHub repository under [superset/config.py](github.com/apache/superset/blob/master/superset/config.py).
