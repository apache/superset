...
use Memcached, Redis, S3 (https://pypi.python.org/pypi/s3werkzeugcache), [MinIO or other S3 compatible service](https://github.com/greggailly/minio-flask-cache), memory or the file system
...
- In order to use dedicated results backend, additional python libraries must be installed. These libraries can be installed using pip.
  ...
  - [minio-flask-cache](https://github.com/greggailly/minio-flask-cache) fir MinIO or other S3 compatible service
