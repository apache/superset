...
- Dashboard Excel export requires a signed-in, non-guest account with an email
  address, including for direct downloads. Logged-in users viewing an embedded
  dashboard can still use the export.
