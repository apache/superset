...
1. **A storage bucket and backend.** Configure `EXCEL_EXPORT_STORAGE` with both
...
| -------------------------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `EXCEL_EXPORT_STORAGE["bucket"]`       | unset                  | Destination bucket. Required; `501` if unset.                                                                                                                                     |
| `EXCEL_EXPORT_STORAGE["backend"]`      | unset                  | Storage backend instance: `S3ExportStorage()` (`superset.utils.s3`), `GCSExportStorage()` (`superset.utils.gcs`), or a custom `superset.utils.export_storage.ExportStorage` implementation. Required; `501` if unset. |
| `EXCEL_EXPORT_STORAGE["key_prefix"]`   | `"dashboard-exports/"` | Object key/blob prefix: `{prefix}{dashboard_id}/{job_id}.xlsx`.                                                                                                                   |
