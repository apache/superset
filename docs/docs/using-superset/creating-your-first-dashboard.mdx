...
In edit mode, adding a tab to an empty Tabs component selects it automatically.
This also applies after deleting the component's last tab and adding a replacement.
