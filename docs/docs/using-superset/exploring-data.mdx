...
In the top menu, select **Settings ‣ Data ‣ Databases Connections**. Find the **examples** database in the list and
...
In the top menu, select **Settings ‣ Data ‣ Databases Connections**. Then, **Upload file to database ‣ Upload CSV**.
