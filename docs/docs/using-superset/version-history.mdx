...
<img
  ...
  alt="The version history panel, showing the current version and an earlier save, each expanded to its change descriptions"
  width="360"
/>
...
predates single-selection highlighting: the UI highlights only the previewed
