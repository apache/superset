...
The CLI rejects windows outside -1 through 36500. Existing stored integers or
runtime config values above 36500 defer scheduled purge with 0, preserving data
until the operator corrects the window. Other malformed standalone values retain
the config/default fallback.
