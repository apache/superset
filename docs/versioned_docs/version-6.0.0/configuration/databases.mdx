...
| [Atgenomix SeqsLab](/docs/6.0.0/configuration/databases#seqslab)              | `pip install seqslab-connector`                                                    | `seqslab+hive://token:{access_token}@{host}:443/{database}?http_path={job_run_id}`                                                                    ｜
