...
.. image:: images/docs/tutorial/tutorial_01_sources_database.png
   :scale: 70%

On the resulting page, click on the green plus sign, near the top right:

.. image:: images/docs/tutorial/tutorial_02_add_database.png
   :scale: 70%
...
.. image:: images/docs/tutorial/tutorial_03_database_name.png
   :scale: 70%

2. Provide the SQLAlchemy Connection URI and test the connection:

.. image:: images/docs/tutorial/tutorial_04_sqlalchemy_connection_string.png
   :scale: 70%
...
.. image:: images/docs/tutorial/tutorial_05_connection_popup.png
   :scale: 50%
...
.. image:: images/docs/tutorial/tutorial_06_list_of_tables.png
   :scale: 70%

If the connection looks good, save the configuration by clicking the **Save**
button at the bottom of the page:

.. image:: images/docs/tutorial/tutorial_07_save_button.png
   :scale: 70%
...
.. image:: images/docs/tutorial/tutorial_08_sources_tables.png
   :scale: 70%

On the resulting page, click on the green plus sign, near the top left:

.. image:: images/docs/tutorial/tutorial_09_add_new_table.png
   :scale: 70%
...
.. image:: images/docs/tutorial/tutorial_10_table_name.png
   :scale: 70%

* The target database from the **Database** drop-down menu (i.e. the one
  you just added above)

.. image:: images/docs/tutorial/tutorial_11_choose_db.png
   :scale: 70%
...
.. image:: images/docs/tutorial/tutorial_12_table_creation_success_msg.png
   :scale: 70%
...
.. image:: images/docs/tutorial/tutorial_13_edit_table_config.png
   :scale: 70%
...
.. image:: images/docs/tutorial/tutorial_14_field_config.png
...
.. image:: images/docs/tutorial/tutorial_15_click_table_name.png

By default, you’ll be presented with a Table View:

.. image:: images/docs/tutorial/tutorial_16_datasource_chart_type.png
...
.. image:: images/docs/tutorial/tutorial_17_choose_time_range.png
...
.. image:: images/docs/tutorial/tutorial_18_choose_metric.png

Select the *COUNT(\*)* metric, then click the green **Query** button near the top
of the explore:

.. image:: images/docs/tutorial/tutorial_19_click_query.png

You’ll see your results in the table:

.. image:: images/docs/tutorial/tutorial_20_count_star_result.png
...
.. image:: images/docs/tutorial/tutorial_21_group_by.png

and run the query:

.. image:: images/docs/tutorial/tutorial_22_group_by_result.png
...
.. image:: images/docs/tutorial/tutorial_23_group_by_more_dimensions.png

And replace *COUNT(\*)* with *max__measurement_flag*:

.. image:: images/docs/tutorial/tutorial_24_max_metric.png
...
.. image:: images/docs/tutorial/tutorial_25_max_temp_filter.png
...
.. image:: images/docs/tutorial/tutorial_26_row_limit.png

We click **Query** and get the following results:

.. image:: images/docs/tutorial/tutorial_27_top_10_max_temps.png
...
.. image:: images/docs/tutorial/tutorial_28_bar_chart.png
...
.. image:: images/docs/tutorial/tutorial_29_bar_chart_series_metrics.png
...
.. image:: images/docs/tutorial/tutorial_30_bar_chart_results.png
   :scale: 70%
...
.. image:: images/docs/tutorial/tutorial_31_save_slice_to_dashboard.png
   :scale: 70%
...
.. image:: images/docs/tutorial/tutorial_32_save_slice_confirmation.png
   :scale: 70%

Let’s check out our new dashboard. We click on the **Dashboards** menu:

.. image:: images/docs/tutorial/tutorial_33_dashboard.png

and find the dashboard we just created:

.. image:: images/docs/tutorial/tutorial_34_weather_dashboard.png

Things seemed to have worked - our slice is here!

.. image:: images/docs/tutorial/tutorial_35_slice_on_dashboard.png
   :scale: 70%
...
.. image:: images/docs/tutorial/tutorial_36_adjust_dimensions.gif
   :scale: 120%
