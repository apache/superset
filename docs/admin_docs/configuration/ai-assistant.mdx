...
Tool details display JSON with readable Unicode and indentation. If a recorded
JSON result was clipped, the panel uses its structured summary when available.
