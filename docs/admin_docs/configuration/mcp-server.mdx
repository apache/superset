...
restoring the affected filters' previous selections. Filters not present in the
notification's permalink keep their existing selections in the open dashboard.
