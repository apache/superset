...
```
import { CategoricalScheme } from '@superset-ui/core'; // Can use existing scheme type or create new types
const schemes = [{
  id: 'myCustomColors',
  label: 'Custom Colors',
  colors: [
  '#1FA8C9', '#454E7C', '#5AC189', '#FF7F44', '#666666', '#E04355', '#FCC700', '#A868B7', '#3CCCCB', '#A38F79',
