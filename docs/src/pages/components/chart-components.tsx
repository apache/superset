...
export default function ComponentsChartComponentsRedirect(): JSX.Element {
  ...
  useEffect(() => {
    ...
    history.replace(`/components/${latestVersion}/chart-components`);
  }, [history]);

  return (
    <div>
      <p>Redirecting to Chart Components...</p>
    </div>
  );
}
