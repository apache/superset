...
export default function ComponentsUIComponentsRedirect(): JSX.Element {
  ...
  useEffect(() => {
    ...
    history.replace(`/components/${latestVersion}/ui-components`);
  }, [history]);

  return (
    <div>
      <p>Redirecting to UI Components...</p>
    </div>
  );
}
